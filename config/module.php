...
return [
    'module_type'=>[
        'grocery', 'food', 'pharmacy', 'ecommerce', 'parcel', 'rental', 'ride_hailing'
    ],
    ...
    'ride_hailing'=>[
        ...
        'brand'=>false,
        'generic_name'=>false,
        'description'=>'Ride-hailing business module. Trip, vehicle, driver, fare, and booking capabilities are configured separately.',
        'is_rental'=>false,
        'is_ride_hailing'=>true,
    ],
];
