...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module', 'actch:admin_panel']], function () {
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::get('all-products-stores', 'ItemController@all_products_with_stores')->name('all-products-stores');
        ...
        Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
            ...
            Route::get('get-account-data/{store}', 'VendorController@get_account_data')->name('account-data');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings']], function () {
            ...
            Route::get('pages/business-page/services-policy', 'BusinessSettingsController@services_policy')->name('services-policy');
            Route::post('pages/business-page/services-policy', 'BusinessSettingsController@services_policy_update');
        ...
        Route::group(['prefix' => 'transactions', 'as' => 'transactions.'], function () {
            ...
            Route::group(['prefix' => 'customer', 'as' => 'customer.'], function () {
                Route::get('withdraw_list', 'CustomerWalletController@withdraw')->name('withdraw_list');
                Route::post('withdraw-status/{id}', 'CustomerWalletController@withdrawStatus')->name('withdraw_status');
                Route::post('status-filter', 'CustomerWalletController@status_filter')->name('status-filter');
                Route::get('withdraw_export', 'CustomerWalletController@withdraw_export')->name('withdraw_export');
                Route::get('get-Withdraw-Details', 'CustomerWalletController@getWithdrawDetails')->name('getWithdrawDetails');
            });
