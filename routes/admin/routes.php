...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module','actch:admin_panel']], function () {
        ...
        /*
         * Typo aliases: some blades/cache use admin.user.delivery-man.* (singular "user").
         * Canonical routes are admin.users.delivery-man.* under /admin/users/delivery-man/...
         */
        Route::group(['middleware' => ['module:deliveryman']], function () {
            Route::get('user/delivery-man/milestone-bonus/awards', function () {
                return redirect()->route('admin.users.delivery-man.milestone-bonus.awards');
            })->name('user.delivery-man.milestone-bonus.awards');

            Route::get('user/delivery-man/milestone-bonus', function () {
                return redirect()->route('admin.users.delivery-man.milestone-bonus');
            })->name('user.delivery-man.milestone-bonus');

            Route::get('user/delivery-man/registration-fee/ledger/{delivery_man_id}', function () {
                return redirect()->route('admin.users.delivery-man.registration-fee');
            })->name('user.delivery-man.registration-fee.ledger');

            Route::get('user/delivery-man/registration-fee', function () {
                return redirect()->route('admin.users.delivery-man.registration-fee');
            })->name('user.delivery-man.registration-fee');
        });
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
                ...
                Route::group(['middleware' => ['module:deliveryman']], function () {
                    ...
                    Route::post('milestone-bonus/store', [DmMilestoneBonusController::class, 'store'])->name('milestone-bonus.store');
                    Route::post('milestone-bonus/update/{id}', [DmMilestoneBonusController::class, 'update'])->name('milestone-bonus.update');
                    Route::delete('milestone-bonus/{id}', [DmMilestoneBonusController::class, 'delete'])->name('milestone-bonus.delete');
                });
            });
        });
    });
