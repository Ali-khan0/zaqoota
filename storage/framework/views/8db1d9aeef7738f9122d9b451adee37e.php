            ...
            <div class="d-flex justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex align-items-start flex-wrap gap-2">
                    <a class="btn btn--cancel h--45px d-flex gap-2 align-items-center form-alert" href="javascript:"
                        data-id="brand-<?php echo e($driver['id']); ?>" data-message="<?php echo e(translate('Want to delete this driver')); ?>"
                        title="<?php echo e(translate('messages.delete_driver')); ?>">
                        <i class="tio-delete-outlined"></i>
                        <?php echo e(translate('messages.delete')); ?>

                    </a>
                    <form action="<?php echo e(route('admin.rental.provider.driver.delete', [$driver['id']])); ?>" method="post"
                        id="brand-<?php echo e($driver['id']); ?>">
                    ...
                    <a href="javascript:"
                        ...
                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox<?php echo e($driver->id); ?>">
                            <input type="checkbox"
                                data-url="<?php echo e(route('admin.rental.provider.driver.status', [$driver['id'], $driver->status ? 0 : 1])); ?>"
                                class="toggle-switch-input redirect-url" id="stocksCheckbox<?php echo e($driver->id); ?>"
                                <?php echo e($driver->status ? 'checked' : ''); ?>>
                            <span class="toggle-switch-label mx-auto">
                                <span class="toggle-switch-indicator"></span>
                            </span>
                        </label>
                    </a>
                    <a href="<?php echo e(route('admin.rental.provider.driver.edit', $driver->id)); ?>"
                            ...
                            <div class="mr-0 mr-lg-4">
                                ...
                                <div class="align-items-center d-flex gap-2 resturant--information-single text-left">
                                    <img height="45" class="aspect-ratio-1 onerror-image rounded"
                                        src="<?php echo e($driver?->provider?->logo_full_url ?? asset('public/assets/admin/img/100x100/1.png')); ?>"
                                        alt="<?php echo e(translate('Image Description')); ?>">
                                    <div class="text--title">
                                        <a class="media align-items-center deco-none resturant--information-single"
                                            href="<?php echo e(isset($driver?->provider) ? route('admin.rental.provider.details', $driver?->provider?->id) : '#'); ?>">
                            ...
                            <?php $__currentLoopData = $driver['identity_image_full_url']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="identify-image-single position-relative">
                                    <img width="275" data-toggle="modal" data-target="#imagemodal<?php echo e($key); ?>"
                                        ...
                                        alt="Identity image">
                                    <a href="<?php echo e($img); ?>" class="download-btn" download="">
            ...
            <div class="card-header py-2">
                <div class="search--button-wrapper gap-20px">
                    <h5 class="card-title text--title flex-grow-1"><?php echo e(translate('messages.Total_Trips')); ?>
                        ...
                        <span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($driverTrips->total()); ?></span>
                    ...
                    <form class="search-form flex-grow-1 max-w-353px">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" value="<?php echo e(request()?->search ?? null); ?>"
                                name="search" class="form-control" placeholder="<?php echo e(translate('Search by trip ID')); ?>"
                    ...
                    <div class="hs-unfold m-0">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="<?php echo e(route('admin.rental.provider.driver.trip.export', ['id' => request()->id, 'type' => 'excel', request()->getQueryString()])); ?>">
                            ...
                            <a id="export-csv" class="dropdown-item"
                                href="<?php echo e(route('admin.rental.provider.driver.trip.export', ['id' => request()->id, 'type' => 'csv', request()->getQueryString()])); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <tbody id="set-rows">
                        <?php $__currentLoopData = $driverTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $driverTrip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.rental.trip.details', $driverTrip?->trip?->id)); ?>"
                                ...
                                <td>
                                    <div class="text--title">
                                        ...
                                        <a href="<?php echo e(route('admin.users.customer.rental.view', $driverTrip?->trip->user_id)); ?>?module=1" target="_blank" rel="noopener noreferrer">
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        <a class="btn action-btn btn--primary btn-outline-primary"
                                            href="<?php echo e(route('admin.rental.trip.generate-invoice', ['id' => $driverTrip?->trip?->id])); ?>"
                                            title="<?php echo e(translate('messages.download')); ?>"><i class="tio-download-to"></i>
                                        </a>
                                        <a class="btn action-btn btn--primary btn-outline-primary"
                                            href="<?php echo e(route('admin.rental.trip.details', $driverTrip?->trip?->id)); ?>"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/driver/details.blade.php ENDPATH**/ ?>