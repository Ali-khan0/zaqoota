...
<?php $__env->startPush('css_or_js'); ?>
    ...
    <style>
       ...
       <link rel="stylesheet" href="<?php echo e(asset('public/assets/admin/vendor/swiper/swiper-bundle.min.css')); ?>" />
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex justify-content-between">
            ...
            <div class="cursor-pointer text-primary d-flex align-items-center gap-3 font-weight-bolder"  data-toggle="modal" data-target="#settingModal">
                ...
                <div class="ripple-animation ml-2">
                    <img src="<?php echo e(asset('/public/assets/admin/img/info.svg')); ?>" class="svg" alt="">
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="single-item-slider owl-carousel">
                            <div class="item">
                                <div class="mb-20">
                                    <div class="">
                                        <img src="<?php echo e(asset('public/assets/admin/img/addon_setting.png')); ?>" loading="lazy" alt="" class="dark-support rounded mb-4 mw-100">
                                        <ol>
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            ...
                            <div class="mt-5 card px-3 py-2 d--none" id="progress-bar">
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    <div class="">
                                        <img width="24" src="<?php echo e(asset('/public/assets/admin/img/upload.png')); ?>" alt="">
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end mt-3">
                                <button type="button"
                                    class="btn btn--primary px-4 zip-upload" id="upload_theme"><?php echo e(translate('upload')); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="row g-1 g-sm-2">
            <?php $__currentLoopData = $addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $addonEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                ...
                <div class="card theme-card">
                    <div class="card-header">
                        ...
                        <div class="d-flex gap-2 gap-sm-3 align-items-center">
                            <?php if(! $isPublished): ?>
                                <button class="text-danger bg-transparent p-0 border-0 mr-2" data-toggle="modal" data-target="#deleteThemeModal_<?php echo e($key); ?>"><img src="<?php echo e(asset('public/assets/admin/img/delete.svg')); ?>" class="svg" alt=""></button>
                                <!-- Delete Theme Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="<?php echo e(asset('public/assets/admin/img/delete.png')); ?>" alt="">
                                                </div>
                            ...
                            <?php endif; ?>
                                ...
                                <button class="<?php echo e($isPublished ? 'checkbox-color-primary' : 'text-muted'); ?> bg-transparent p-0 border-0" data-toggle="modal" data-target="#shiftThemeModal_<?php echo e($key); ?>"><img src="<?php echo e(asset('public/assets/admin/img/check.svg')); ?>" class="svg" alt=""></button>
                                    ...
                                    <div class="modal-dialog status-warning-modal">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 pt-0 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="<?php echo e(asset('public/assets/admin/img/addon.png')); ?>" alt="">
                                                </div>
                                                ...
                                                <div class="btn--container justify-content-center mb-3">
                                                    ...
                                                    <button type="button" class="fs-16 btn btn--primary px-sm-5 publish-addon" data-path="<?php echo e($addon); ?>" data-status="<?php echo e($isPublished ? 0 : 1); ?>" data-dismiss="modal"><?php echo e(translate('yes')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="p-2 p-sm-3">
                        ...
                        <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                            ...
                            data-onerror-image="<?php echo e(asset('public/assets/admin/img/placeholder.png')); ?>"
                                src="<?php echo e(asset('public/assets/admin/img/addon.png')); ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo e(asset('public/assets/admin/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
    ...
    $('.publish-addon').on('click', function () {
        ...
        let status = $(this).data('status');
            ...
            $.post({
                    ...
                    error: function (xhr) {
                        toastr.error(xhr.responseJSON?.message || '<?php echo e(translate("Failed_to_update_Rental_addon_status._Check_the_server_log_for_details.")); ?>', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                    }
        ...
        $('.theme-delete').on('click', function () {
            ...
            $.post({
                ...
                error: function (xhr) {
                    toastr.error(xhr.responseJSON?.message || '<?php echo e(translate("Unable_to_delete_addon._Check_file_permissions_and_the_server_log.")); ?>', {
                        CloseButton: true,
                        ProgressBar: true
                    });
                },
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/system/addon/index.blade.php ENDPATH**/ ?>