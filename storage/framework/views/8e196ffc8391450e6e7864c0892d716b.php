            ...
            <div class="container">
                <div class="navbar-bottom-wrapper">
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('services-policy')); ?>" class="<?php echo e(Request::is('services-policy') ? 'active' : ''); ?>"><span><?php echo e(translate('messages.services_policy')); ?></span></a>
                        </li>
                        <li>
                        ...
                        <?php if($fixed_link &&$fixed_link['web_app_url_status']): ?>
                            <div class="me-2 d-lg-none">
                                <a class="cmn--btn me-xl-auto py-2" href="<?php echo e($fixed_link['web_app_url']); ?>" target="_blank">Open Zaqoota</a>
                            </div>
                        <?php endif; ?>
                    </ul>
                ...
                <div class="footer-wrapper ps-xl-5">
                    ...
                    <div class="footer-widget widget-links">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('services-policy')); ?>"><?php echo e(translate('messages.services_policy')); ?></a>
                            </li>
                            <li>
                            ...
                            <?php endif; ?>
                            <li>
                                <a href="<?php echo e(route('account-deletion-request')); ?>"><?php echo e(translate('Account Deletion Request')); ?></a>
                            </li>
...
<?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/layouts/landing/app.blade.php ENDPATH**/ ?>