                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-xl-between justify-content-center text-xl-start text-center flex-xl-nowrap">
                            <div class="d-flex gap-x-xl-20 align-items-center flex-xl-nowrap flex-wrap">
                                <div class="w-100px min-w-100px h-100px d-center mb-xl-0 mb-2 mx-auto">
                                    <img src="<?php echo e(asset('/public/assets/admin/img/400x400/high-light-car.png')); ?>" alt="" class="object-contain">
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/test/React_Landing/high-light-section.blade.php ENDPATH**/ ?>