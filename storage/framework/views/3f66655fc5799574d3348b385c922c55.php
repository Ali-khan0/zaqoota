                    ...
                    <li class="nav-item max-sm-m-0 w-xxl-200px ml-auto mr-2 flex-grow-0">
                        <button type="button" id="modalOpener" class="title-color bg--secondary border-0 rounded justify-content-between w-100 align-items-center py-2 px-2 px-md-3 d-flex gap-1" data-toggle="modal" data-target="#staticBackdrop">
                            <div class="align-items-center d-flex flex-grow-1 gap-1 justify-content-between">
                                ...
                                <img width="14" src="<?php echo e(asset('/public/assets/admin/img/new-img/search.svg')); ?>" class="svg" alt="">
                            </div>
                        </button>
                    </li>
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img  onerror-image aspect-1-1"  data-onerror-image="<?php echo e(asset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5"><?php echo e(\App\CentralLogics\Helpers::get_loggedin_user()->f_name); ?> <?php echo e(\App\CentralLogics\Helpers::get_loggedin_user()->l_name); ?></span>
                                            <span class="card-text"><?php echo e(\App\CentralLogics\Helpers::get_loggedin_user()->email); ?></span>
                                        </div>
                                    </div>
                                </div>
...
<?php if($Payable_Balance == 1 &&  $cash_in_hand_overflow &&  $wallet?->balance < 0 &&  $val <=  abs($wallet?->collected_cash)  ): ?>
    <div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
        <img class="rounded mr-1"  width="25" src="<?php echo e(asset('/public/assets/admin/img/header_warning.png')); ?>" alt="">
        <div class="cont">
...
<?php if($Payable_Balance == 1 &&  $cash_in_hand_overflow &&  $wallet?->balance < 0 &&  $cash_in_hand_overflow_store_amount < $wallet?->collected_cash): ?>
    <div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
        <img class="mr-1"  width="25" src="<?php echo e(asset('/public/assets/admin/img/header_warning.png')); ?>" alt="">
        <div class="cont">
...
<?php if( !in_array($store_data->store_business_model, ['none','commission']) && !Request::is('vendor-panel/subscription/*') ): ?>
        ...
        ?>
        <?php if($store_data?->store_sub?->is_trial == 0 && $store_data?->store_sub?->expiry_date_parsed && $store_data?->store_sub->expiry_date_parsed->subDays((int) $subscription_deadline_warning_days)->isBefore(now()) && Request::is('vendor-panel')): ?>

                <!--Always in header Renew -->
                <div class="renew-badge mb-20" id="renew-badge">
                    <div class="renew-content d-flex align-items-center">

                        <img src="<?php echo e(asset('/public/assets/admin/img/timer.svg')); ?>" alt="">
                        <div class="txt">
        ...
        <?php elseif( Session::get('subscription_renew_close_btn') !== true && $store_data?->store_sub?->is_trial == 0  && $store_data?->store_sub?->expiry_date_parsed && $store_data?->store_sub->expiry_date_parsed->subDays( (int) $subscription_deadline_warning_days)->isBefore(now()) && !Request::is('vendor-panel')): ?>
        ...
        <div class="free-trial trial success-bg">
            <div class="inner-div">
                <div class="left">
                    <img src="<?php echo e(asset('/public/assets/admin/img/icon-puck.svg')); ?>" alt="">
                        ...
                        <div class="trial-ended-modal-wrapper">
                            <div class="trial-ended-modal-content align-self-center">
                                ...
                                <div class="blocked-subscription mt-5">
                                    <img src="<?php echo e(asset('/public/assets/admin/img/WarningOctagon.svg')); ?>" alt="">
                            ...
                            <div class="trial-ended-modal-img d-none d-md-block">
                                <img src="<?php echo e(asset('/public/assets/admin/img/trial-ended-bg.png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="free-trial trial danger-bg">
            <div class="inner-div">
                <div class="left">
                    <img src="<?php echo e(asset('/public/assets/admin/img/timer-2.svg')); ?>" alt="">
                    <div class="left-content">
...
<?php /**PATH /var/www/zaqoota/resources/views/layouts/vendor/partials/_header.blade.php ENDPATH**/ ?>