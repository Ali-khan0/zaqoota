        ...
        <div class="store-report-content mt-11px">
            <div class="left-content">
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        <h4 class="subtitle">
                            <?php echo e(\App\CentralLogics\Helpers::number_format_short($orders->sum('transaction_sum_admin_commission')-$orders->sum('transaction_sum_fleet_manager_commission'))); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/report/store-sales-report.blade.php ENDPATH**/ ?>