                                ...
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        <label class="text--title fs-16 font-semibold mb-1">
                                            <?php echo e(translate('Vehicle_Thumbnail')); ?>
                                        ...
                                        <div class="upload-file image-general d-inline-block w-auto">
                                            ...
                                            <input type="file" name="thumbnail"
                                                   data-type="<?php echo e(translate('please_only_input_png_or_jpg_type_file')); ?>"
                                                   data-size="<?php echo e(translate('file_size_too_big')); ?>"
                               ...
                               <div class="d-flex gap-3 flex-shrink-0" id="image_container">
                                   <div class="upload-file text-wrapper h--100px w--200px flex-shrink-0"
                                       ...
                                       <input type="file" name="images[]"
                                              ...
                                              data-maximum="<?php echo e(translate('You can upload a maximum of ')); ?>"
                                              data-content="<?php echo e(translate(' files')); ?>"
                                              data-size="<?php echo e(translate('file_size_too_big.')); ?>"
                                              data-type="<?php echo e(translate('please_only_input_png_or_jpg_type_file')); ?>"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="category_id" id="choice_category" class="form-control js-select2-custom" data-placeholder="<?php echo e(translate('messages.select_vehicle_category')); ?>" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="type" id="choice_type" class="form-control js-select2-custom"
                                            ...
                                            <option value="family"><?php echo e(translate('messages.family')); ?></option>
                                            <option value="luxury"><?php echo e(translate('messages.Luxury')); ?></option>
                                            <option value="affordable"><?php echo e(translate('messages.Affordable')); ?></option>
                                            <option value="executives"><?php echo e(translate('messages.Executives')); ?></option>
                                            <option value="compact"><?php echo e(translate('messages.Compact')); ?></option>
                                            <option value="full_size"><?php echo e(translate('messages.Full-Size')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="fuel_type" id="choice_fuel_type"
                                            ...
                                            <option value="octan" ><?php echo e(translate('messages.Octan')); ?></option>
                                            <option value="diesel" ><?php echo e(translate('messages.diesel')); ?></option>
                                            <option value="CNG" ><?php echo e(translate('messages.CNG')); ?></option>
                                            <option value="petrol" ><?php echo e(translate('messages.Petrol')); ?></option>
                                            <option value="electric" ><?php echo e(translate('messages.Electric')); ?></option>
                                            <option value="jet_fuel" ><?php echo e(translate('messages.Jet Fuel')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="transmission_type" id="choice_transmission_type"
                                            ...
                                            <option value="automatic"><?php echo e(translate('Automatic')); ?></option>
                                            <option value="manual"><?php echo e(translate('Manual')); ?></option>
                                            <option value="continuously_variable"><?php echo e(translate('Continuously Variable')); ?></option>
                                            <option value="dual_clutch"><?php echo e(translate('Dual-Clutch')); ?></option>
                                            <option value="semi_automatic"><?php echo e(translate('Semi-Automatic')); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/view-pages/provider/vehicle-create.js')); ?>"></script>
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/view-pages/provider/multiple-upload.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/provider/vehicle/create.blade.php ENDPATH**/ ?>