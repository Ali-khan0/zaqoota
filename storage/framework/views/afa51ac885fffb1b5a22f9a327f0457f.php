                                        ...
                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-xl-between justify-content-center text-xl-start text-center flex-xl-nowrap">
                                            <div class="d-xl-flex gap-x-xl-20 align-items-center flex-xl-nowrap flex-wrap">
                                                <div class="w-50px bg-white h-50px min-h-50 rounded-circle d-center mx-auto mb-xl-0 mb-2">
                                                    <img src="<?php echo e(asset('/public/assets/admin/img/icons/faq-question.png')); ?>" alt="" class="object-contain">
                                                </div>
                                                <div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/test/React_Landing/faq-section.blade.php ENDPATH**/ ?>