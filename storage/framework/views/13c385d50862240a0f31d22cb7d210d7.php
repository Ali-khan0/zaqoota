                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="banner-thumb w-100 h-100 rounded-10">
                                    <img height="80" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-landing-banner.png')); ?>" alt="" class="rounded-10">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/test/React_Landing/banners-section.blade.php ENDPATH**/ ?>