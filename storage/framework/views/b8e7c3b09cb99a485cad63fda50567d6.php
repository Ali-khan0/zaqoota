    ...
    <div class="content container-fluid">
        ...
        <div class="disbursement-report mb-20">
            <div class="__card-3 rebursement-item">
                <img src="<?php echo e(asset('public/assets/admin/img/report/new/trx1.png')); ?>" class="icon" alt="report/new">
                ...
                <div class="info-icon" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo e(translate('When_the_disbursement_is_pending_full_order_amount_goes_to_this_section.')); ?>">
                    <img src="<?php echo e(asset('public/assets/admin/img/report/new/info1.png')); ?>" alt="report/new">
                </div>
            </div>

            <div class="__card-3 rebursement-item">
                <img src="<?php echo e(asset('public/assets/admin/img/report/new/trx5.png')); ?>" class="icon" alt="report/new">
                ...
                <div class="info-icon" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo e(translate('When_the_disbursement_is_completed_full_order_amount_goes_to_this_section.')); ?>">
                    <img src="<?php echo e(asset('public/assets/admin/img/report/new/info5.png')); ?>" alt="report/new">
                </div>
            </div>

            <div class="__card-3 rebursement-item">
                <img src="<?php echo e(asset('public/assets/admin/img/report/new/trx3.png')); ?>" class="icon" alt="report/new">
                ...
                <div class="info-icon" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo e(translate('When_the_disbursement_is_canceled_full_order_amount_goes_to_this_section.')); ?>">
                    <img src="<?php echo e(asset('public/assets/admin/img/report/new/info3.png')); ?>" alt="report/new">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/vendor-views/report/disbursement-report.blade.php ENDPATH**/ ?>