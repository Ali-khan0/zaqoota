...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form id="coupon_update_form" action="<?php echo e(route('admin.rental.coupon.update',[$coupon['id']])); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                        <div class="col-12">
                            <?php if($language): ?>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <select name="coupon_type" id="coupon_type" class="form-control">
                                    <option value="store_wise" <?php echo e($coupon['coupon_type']=='store_wise'?'selected':''); ?>><?php echo e(translate('messages.provider_wise')); ?></option>
                                    <option value="zone_wise" <?php echo e($coupon['coupon_type']=='zone_wise'?'selected':''); ?>><?php echo e(translate('messages.zone_wise')); ?></option>
                                    
                                    <option value="first_order" <?php echo e($coupon['coupon_type']=='first_order'?'selected':''); ?>><?php echo e(translate('messages.first_trip')); ?></option>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6" id="store_wise">
                            <div class="form-group m-0 ">
                                    ...
                                    <select name="store_ids[]" id="store_id" data-url="<?php echo e(route('admin.store.get-providers')); ?>" class="js-data-example-ajax form-control"  title="Select Restaurant">
                                    ...
                                    <?php ($store=\App\Models\Store::find(json_decode($coupon->data)[0])); ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else: ?>
                                    <option selected><?php echo e(translate('Select Provider')); ?></option>
                                    <?php endif; ?>
                                    </select>
                                </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-lg-3 col-sm-6" id="customer_wise" style="display: <?php echo e($coupon['coupon_type'] =='zone_wise' || $coupon['coupon_type'] =='first_order' ?'none':'block'); ?>">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" data-error-text="<?php echo e(translate("Discount amount cannot be greater than minimum purchase amount")); ?>" id="min_purchase" name="min_purchase" step="0.01" value="<?php echo e($coupon['min_purchase']); ?>"
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="number" id="discount" min="1" max="999999999999.99" step="0.01" value="<?php echo e($coupon['discount']); ?>"
                                       name="discount" class="form-control"  placeholder="<?php echo e(translate('messages.Ex :')); ?> 100" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="form-group m-0">
    ...
    <input type="hidden" id="defaut_coupon_discount_type" value="<?php echo e($coupon?->discount_type); ?>" >
    <input type="hidden" id="defaut_coupon_type" value="<?php echo e($coupon?->coupon_type); ?>" >
    <input type="hidden" id="defaut_coupon_expire_date" value="<?php echo e($coupon?->expire_date); ?>" >
    <input type="hidden" id="defaut_coupon_start_date" value="<?php echo e($coupon?->start_date); ?>" >

<?php $__env->stopSection(); ?>

<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('public/assets/admin/js/view-pages/coupon-edit.js')); ?>"></script>
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/coupon-edit.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/coupon/edit.blade.php ENDPATH**/ ?>