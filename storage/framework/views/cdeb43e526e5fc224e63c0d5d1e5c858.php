            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_a_Provider_successfully_shift_to_a_plan_they_will_get_a_confirmation_email.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p><?php echo e(translate('If_enabled,_providers_will_get_a_subscription_shift_email_when_they_successfully_shift_their_subscription.')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_providers_will_not_get_a_subscription_shift_email_when_a_provider_successfully_shift_their_subscription.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.rental-email-status',['provider','subscription-shift',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.rental-email-setup', ['provider','subscription-shift'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
