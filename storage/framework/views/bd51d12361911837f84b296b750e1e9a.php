...
<?php $__env->startPush('css_or_js'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('Modules/Rental/public/assets/css/provider/trip-details.css')); ?>">
<?php $__env->stopPush(); ?>
                        ...
                        <div class="d-flex align-items-start justify-content-between flex-wrap mb-2">
                            <div class="order-invoice-left d-flex d-sm-block justify-content-between">
                                <div>
                                    ...
                                    <div class="fs-14 text-title mt-2 pt-1 mb-2 d-flex align-items-center __gap-5px">
                                        ...
                                        <?php elseif($trip->trip_type == 'hourly'): ?>
                                ...
                                <div class="d-sm-none">
                                    <a class="btn btn--primary print--btn font-regular d-flex align-items-center __gap-5px"
                                       href="<?php echo e(route("vendor.trip.generate-invoice",["id" => $trip->id])); ?>">
                            ...
                            <div class="order-invoice-right mt-3 mt-sm-0">
                                <div class="btn--container ml-auto align-items-center justify-content-end">
                                    ...
                                    <?php endif; ?>
                                    <a class="btn btn--primary print--btn font-bold d-none d-sm-block" href="<?php echo e(route("vendor.trip.generate-invoice",["id" => $trip->id])); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media media--sm">
                                                <a class="avatar avatar-xl mr-3" href="<?php echo e(route('vendor.vehicle.details', $detail->vehicle_id)); ?>">
                                                ...
                                                <div class="media-body">
                                                    <div class="fs-12 text--title">
                                                        <div class="fz-12 font-semibold line--limit-1">
                                                            ...
                                                            <div><span class="font-semibold mr-2"><?php echo e(translate('Category')); ?> :</span><?php echo e($detail?->vehicle?->category?->name); ?></div>
                                                            <div><span class="font-semibold mr-2"><?php echo e(translate('Brand')); ?> :</span><?php echo e($detail?->vehicle?->brand?->name); ?></div>
                                                            <?php else: ?>
                                                ...
                                                <?php if(!in_array($trip->trip_status, ['ongoing','pending', 'completed', 'canceled']) && $is_deleted != 1): ?>
                                                    <div class="mt-2">
                                                        <button
                                                            ...
                                                            data-category = "<?php echo e($detail?->vehicle?->category?->name); ?>"
                                                            data-brand = "<?php echo e($detail?->vehicle?->brand?->name); ?>"
                                            ...
                                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($status !== strtolower($trip->trip_status)): ?>
                                                    <a class="dropdown-item route-alert"
                                                       data-url="<?php echo e(route('vendor.trip.status', ['id' => $trip['id'], 'status' => $status])); ?>"
                                    ...
                                    <div class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <?php $__currentLoopData = $paymentStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($status !== strtolower($trip->payment_status)): ?>
                                                <a class="dropdown-item route-alert"
                                                   data-url="<?php echo e(route('vendor.trip.payment.status', ['id' => $trip['id'], 'status' => $status])); ?>"
                                                   data-message="Change status to <?php echo e(translate($status)); ?>?" href="javascript:">
                                                    <?php echo e(translate($status)); ?>
    ...
    <div class="modal fade" id="assignDriverModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('vendor.trip.assign.driver')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media media--sm">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="fs-12 text--title">
                                                            <div class="font-bold"><?php echo e(ucwords($vehicleDetails?->vehicles?->name)); ?></div>
    ...
    <div class="modal fade" id="assignVehicleModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('vendor.trip.assign.vehicle')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body px-4 py-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media media--sm eta_amount">
                                                    ...
                                                    <a class="avatar avatar-xl mr-3" href="<?php echo e(route('vendor.vehicle.details', $editDetail->vehicle_id)); ?>">
                                                        <img class="img-fluid rounded aspect-ratio-1 onerror-image"
                                                    ...
                                                    <div class="media-body">
                                                        <div class="fs-12 text--title">
                                                            ...
                                                            <div><span class="font-semibold mr-2"><?php echo e(translate('Category')); ?> :</span><?php echo e($editDetail?->vehicle?->category?->name); ?>

                                                            </div>
                                                            <div><span class="font-semibold mr-2"><?php echo e(translate('Brand')); ?> :</span><?php echo e($editDetail?->vehicle?->brand?->name); ?>
                                            ...
                                            <td>
                                                <div class="fs-14 eta_amount text--title">
                                                      <?php
                                                            ...
                                                            ?>
                                                    <?php echo e(\App\CentralLogics\Helpers::format_currency($getPrice)); ?>
...
<input type="hidden" id="tax_included" value="<?php echo e(translate('(Included)')); ?>">
    ...
    <div id="get_calculation_url" data-url="<?php echo e(route('vendor.trip.get-calculation')); ?>"></div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/view-pages/provider/trip-details.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/provider/trip/details.blade.php ENDPATH**/ ?>