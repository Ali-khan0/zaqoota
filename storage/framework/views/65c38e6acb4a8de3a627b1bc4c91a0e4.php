            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Subscribed_providers_will_get_a_reminder_mail_when_their_subscription_is_about_to_end.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p><?php echo e(translate('If_enabled,Subscribed_providers_will_get_a_reminder_mail_when_their_subscription_is_about_to_end.')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,Subscribed_providers_will_not_get_a_reminder_mail_when_their_subscription_is_about_to_end.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.rental-email-status',['provider','subscription-deadline',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.rental-email-setup', ['provider','subscription-deadline'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
