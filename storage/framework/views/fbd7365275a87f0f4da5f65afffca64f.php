                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <form class="search-form">
                        <div class="input-group input--group">
                            <input name="search" type="search" value="<?php echo e(request()?->search); ?>" class="form-control h--40px" placeholder="<?php echo e(translate('Ex : Search by vehicle name')); ?>" aria-label="Search here">
                    ...
                    <div class="hs-unfold">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="<?php echo e(route('vendor.vehicle.review.export', ['export_type' => 'excel', request()->getQueryString()])); ?>">
                    ...
                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div class="position-relative media align-items-center">
                                        <a class=" text-hover-primary absolute--link" href="<?php echo e(route('vendor.vehicle.details',$review->vehicle_id)); ?>">
                                            <img class="avatar avatar-lg mr-3  onerror-image"  data-onerror-image="<?php echo e(asset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                                                 src="<?php echo e($review->vehicle->thumbnail_full_url); ?>" alt="<?php echo e($review?->vehicle?->name); ?> image">
                                        </a>
                                ...
                                <?php else: ?>
                                    <?php echo e(translate('messages.Vehicle_deleted!')); ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="position-relative media align-items-center">
                                                ...
                                                <img class="avatar avatar-lg mr-3  onerror-image"  data-onerror-image="<?php echo e(asset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                                                     src="<?php echo e($review?->vehicle?->thumbnail_full_url ?? asset('public/assets/admin/img/160x160/img1.jpg')); ?>" alt="<?php echo e($review?->vehicle?->name); ?> image">
                                                <div>
                                                    <h5 class="text-hover-primary mb-0"><?php echo e($review?->vehicle?->name ?? translate('vehicle_deleted')); ?></h5>
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/provider/review/list.blade.php ENDPATH**/ ?>