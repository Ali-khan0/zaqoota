...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        <div class="page-header">
            ...
            <div class="mt-2">
                <a href="<?php echo e(route('admin.users.delivery-man.milestone-bonus.awards')); ?>" class="btn btn-sm btn--primary"><?php echo e(translate('messages.dm_bonus_awards')); ?></a>
            </div>
        </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.users.delivery-man.milestone-bonus.store')); ?>" method="post" class="row align-items-end">
                    <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <form action="<?php echo e(route('admin.users.delivery-man.milestone-bonus.update', $m->id)); ?>" method="post" class="form-inline flex-wrap align-items-center">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('admin.users.delivery-man.milestone-bonus.delete', $m->id)); ?>" method="post" class="d-inline" onsubmit="return confirm('<?php echo e(translate('messages.are_you_sure')); ?>');">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/delivery-man/milestone-bonus/index.blade.php ENDPATH**/ ?>