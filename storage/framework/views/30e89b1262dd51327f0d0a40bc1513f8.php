<?php $__env->startSection('title',translate('messages.restaurant_bulk_export')); ?>
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.export_stores')); ?>
        ...
        <div class="card rest-part">
            <div class="card-body p-2">
                ...
                <form class="product-form px-3 pb-3" action="<?php echo e(route('admin.store.bulk-export')); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/zaqoota/resources/views/admin-views/vendor/bulk-export.blade.php ENDPATH**/ ?>