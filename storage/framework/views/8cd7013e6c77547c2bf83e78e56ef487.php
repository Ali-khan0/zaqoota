        ...
        <div class="card-header flex-wrap gap-2 border-0 align-items-center">
            <div>
                <h3 class="card-title mb-1 align-items-center gap-2">
                    ...
                    <span class="text-title"><?php echo e(translate('Package Overview')); ?></span>
                </h3>
        ...
        <div class="card-body pt-0">
            <div class="bg-F7F8F9 p--20 rounded mb-20">
                <div class="row g-3 align-items-center">
                    <div class="col-md-6">
                        <div class="max-w-595">
                            <h3 class="name"><?php echo e(translate('Commission Base Plan')); ?></h3>
                            <div class="info-text fs-14">
                                <?php echo e(translate('Store will pay')); ?> <?php echo e($store->comission > 0 ?  $store->comission :  $admin_commission); ?>% <?php echo e(translate('commission to')); ?> <strong><?php echo e($business_name); ?></strong> <?php echo e(translate('from each order. You will get access of all the features and options  in store panel , app and interaction with user.')); ?>
                    ...
                    <div class="col-md-6">
                        <div class="bg-white d-flex align-items-center justify-content-between gap-2 flex-wrap rounded py-3 px-xxl-4 px-3">
                            <h4 class="title mt-2">
                                ...
                                <span class="fs-14 font-semibold d-block"><?php echo e(translate('messages.Commission_per_order')); ?></span>
                            </h4>
                            <img width="40" src="<?php echo e(asset('public/assets/admin/img/money-percentage.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="">
                            <form action="<?php echo e(route('admin.store.update-settings',[$store['id'] , 'tab' => 'business_plan'])); ?>" method="post">
                                ...
                                <div class="row align-items-center g-3">
                                    <div class="col-md-6">
                                        <div class="max-w-595">
                                            <h3 class="name"><?php echo e(translate('Change Commission Rate')); ?></h3>
                                            <div class="info-text fs-14">
                                                <?php echo e(translate('When enabled admin will only receive the certain commission percentage set for this store. Otherwise the system default commission will be applied.')); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-20">
                                            <label class="d-flex mb-1 justify-content-between switch toggle-switch-sm text-dark bg-white rounded border py-2 px-3 text-capitalize" for="comission_status">
                                                <span class="fs-14 lh-1"><?php echo e(translate('messages.Status')); ?></span>
                                        ...
                                        <div>
                                            <label class="d-flex mb-2 justify-content-between text-dark text-capitalize">
                                                <span><?php echo e(translate('messages.Change_Commission_Rate')); ?>(%)                                                 
                                            </label>
                                ...
                                <div class="d-flex align-items-center justify-content-end gap-3 mt-4">
                                    <button type="submit" class="btn min-w-120px btn--reset h--45px"><?php echo e(translate('Reset')); ?></button>
                                    <button type="submit" class="btn min-w-120px btn--primary h--45px"><?php echo e(translate('Change')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <!-- <div class="__bg-F8F9FC-card __plan-details">
                <div class="d-flex flex-wrap flex-md-nowrap justify-content-between __plan-details-top">
                    <div class="w-100">
                        <h3 class="name text--primary"><?php echo e(translate('Commission Base Plan')); ?></h3>
                        <h4 class="title mt-2"><span class="text-180"><?php echo e($store->comission > 0 ?  $store->comission :  $admin_commission); ?> %</span> <?php echo e(translate('messages.Commission_per_order')); ?></h4>
                        <div class="info-text ">
                            <?php echo e(translate('Store will pay')); ?> <?php echo e($store->comission > 0 ?  $store->comission :  $admin_commission); ?>% <?php echo e(translate('commission to')); ?> <strong><?php echo e($business_name); ?></strong> <?php echo e(translate('from each order. You will get access of all the features and options  in store panel , app and interaction with user.')); ?>
                    ...
                    <div class="card-header flex-wrap gap-2 border-0 align-items-center">
                        <div>
                            <h3 class="card-title align-items-center gap-2">
                                ...
                                <span class="text-title"><?php echo e(translate('Package Overview')); ?>
                        ...
                        <div class="btn--container justify-content-end mt-20">
                            ...
                            <?php endif; ?>
                            <button type="button" data-toggle="modal" data-target="#plan-modal" class="btn text-wrap btn--primary"><?php echo e(translate('Change / Renew Subscription Plan')); ?></button>
                        </div>
                    </div>
                    <div class="card-body pt-0">
                        <div class="bg-F7F8F9 p--20 rounded mb-20">
                            ...
                            <div class="check--grid-wrapper mt-3 max-w-850px">
                                <div>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="form-check-label text-dark"><?php echo e(translate('messages.unlimited_orders')); ?></span>
                                        <?php else: ?>
                                        <span class="form-check-label text-dark"> <?php echo e($store?->store_sub_update_application?->package?->max_order); ?> <?php echo e(translate('messages.Orders')); ?> <small>(<?php echo e($store?->store_sub_update_application?->max_order); ?> <?php echo e(translate('left')); ?>) </small> </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="form-check-label text-dark"><?php echo e(translate('messages.unlimited_item_Upload')); ?></span>
                                        <?php else: ?>
                                        <span class="form-check-label text-dark"> <?php echo e($store?->store_sub_update_application?->max_product); ?> <?php echo e(translate('messages.product_Upload')); ?> <small>(<?php echo e($store?->store_sub_update_application?->max_product  - $store->items_count > 0 ? $store?->store_sub_update_application?->max_product  - $store->items_count : 0); ?> <?php echo e(translate('left')); ?>) </small></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="__plan-item hover <?php echo e($store?->store_sub_update_application?->package_id == $package->id  && $store->store_business_model != 'commission'  ? 'active' : ''); ?>">
                                <div class="inner-div">
                                    ...
                                    <ul class="info">
                                        ...
                                        <li>
                                            <i class="tio-checkmark-circle"></i> <span>  <?php echo e(translate('messages.Unlimited_Orders')); ?> </span>
                                        </li>
                                        <?php else: ?>
                                        <li>
                                            <i class="tio-checkmark-circle"></i> <span>  <?php echo e($package->max_order); ?> <?php echo e(translate('messages.Orders')); ?> </span>
                                        </li>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/zaqoota/resources/views/admin-views/vendor/view/subscription.blade.php ENDPATH**/ ?>