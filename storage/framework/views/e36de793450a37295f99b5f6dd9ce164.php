            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_a_Provider_requests_for_a_withdrawal_and_Admin_approves_it,_the_Provider_will_get_an_automated_Withdraw_Approval_email_from_the_system')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p><?php echo e(translate('If_enabled,_Providers_will_receive_an_approval_mail_for_requesting_a_withdrawal.')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_Providers_will_not_receive_any_Withdraw_Approval_mail.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.rental-email-status',['provider','withdraw-approve',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.rental-email-setup', ['provider','withdraw-approve'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
