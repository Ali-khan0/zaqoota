                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6 col-xl-4 col-xxl-3">
                                <div class="d-flex justify-content-center justify-content-md-start gap-3">
                                    ...
                                    <div>
                                        <h6 class="mb-1"><?php echo e(__('fleet_management.fleet_manager')); ?></h6>
                                        <?php if($deliveryMan->fleetManager): ?>
                                            <a href="<?php echo e(route('admin.users.delivery-man.fleet-manager.report', $deliveryMan->fleetManager->id)); ?>">
                                                <?php echo e($deliveryMan->fleetManager->full_name); ?>

                                            </a>
                                            <p class="mb-0 font-weight-normal">
                                                <a href="tel:<?php echo e($deliveryMan->fleetManager->phone); ?>"><?php echo e($deliveryMan->fleetManager->phone); ?></a>
                                            </p>
                                        <?php else: ?>
                                            <p class="mb-0 font-weight-normal"><?php echo e(__('fleet_management.unassigned')); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/delivery-man/view/info.blade.php ENDPATH**/ ?>