            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        <img src="<?php echo e(asset('/public/assets/admin/img/sent-mail-box.png')); ?>" alt="" class="mb-20">
                    ...
                    <div class="btn--container justify-content-center">
                        <a href="<?php echo e(route('admin.business-settings.third-party.test')); ?>" class="btn btn--primary min-w-120">
                            <img src="<?php echo e(asset('/public/assets/admin/img/paper-plane.png')); ?>" alt=""> <?php echo e(translate('Send Test Mail')); ?>
    ...
    <div class="modal fade" id="update-data-modal">
        <div class="modal-dialog status-warning-modal">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        <img src="<?php echo e(asset('/public/assets/admin/img/mail-config/save-data.png')); ?>" alt="" class="mb-20">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/business-settings/mail-index.blade.php ENDPATH**/ ?>