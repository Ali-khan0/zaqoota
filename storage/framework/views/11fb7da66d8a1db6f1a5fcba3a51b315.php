<?php $__env->startSection('title',translate('messages.provider_bulk_export')); ?>
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.export_providers')); ?>
        ...
        <div class="card rest-part">
            <div class="card-body p-2">
                ...
                <form class="product-form px-3 pb-3" action="" method="POST"
...
<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/provider-bulk-export.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/provider/bulk-export.blade.php ENDPATH**/ ?>