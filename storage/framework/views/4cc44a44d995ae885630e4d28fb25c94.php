...
<?php $__env->startPush('css_or_js'); ?>
    ...
    <link href="<?php echo e(asset('Modules/Rental/public/assets/css/admin/provider-overview.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card h-100 card--bg-1">
                        <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                            <h5 class="cash--subtitle text-white">
                                <?php echo e(translate('messages.collected_cash_by_provider')); ?>
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-3">
                                ...
                                <h2 class="cash--title text-white"><?php echo e(\App\CentralLogics\Helpers::format_currency($wallet->collected_cash)); ?></h2>
                            </div>
                        </div>
                        <div class="card-footer pt-0 bg-transparent border-0">
                            <button class="btn text-white text-capitalize bg--title h--45px w-100" id="collect_cash"
                                    ...
                                    title="Collect Cash"><?php echo e(translate('messages.collect_cash_from_provider')); ?>
                        ...
                        <div class="col-sm-6">
                            <div class="resturant-card card--bg-2">
                                ...
                                <img class="resturant-icon w--30"
                                     src="<?php echo e(asset('public/assets/admin/img/transactions/pending.png')); ?>"
                                     alt="transaction">
                            </div>
                        </div>
            ...
            <div class="row g-2" id="order_stats">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <a class="order--card h-100" href="#">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                <?php echo e(translate('Cancellation rate')); ?>

                            </h6>
                            <span class="card-title text--warning">
                                <?php echo e(number_format($canceled > 0 ? ($canceled / $all) * 100 : 0)); ?>%
                            </span>
                        </div>
                    </a>
                    <!-- End Card -->
                    ...
                    <div class="details d-flex flex-wrap flex-column flex-sm-row gap-40px">
                        <div class="details-single d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <span class="fs-13 lh--12 color-484848"><?php echo e($store?->zone?->name); ?></span>
                            </div>
                        </div>
                        <div class="details-single d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <span class="fs-13 lh--12 color-484848"><?php echo e(ucwords($store->store_business_model)); ?></span>
                            </div>
                        </div>
                        <div class="details-single d-flex align-items-center gap-2">
                ...
                <div class="row g-3">
                                                    ...
                                                    <li class="d-flex align-items-start">
                                                        ...
                                                        <div>
                                                            <div class="short-description">
                                                                <span>: <?php echo e(Str::limit($store->getRawOriginal('address'), 500)); ?> </span>
                                                            </div>
                                                    ...
                                                    <div class="fs-12 opacity-lg description-text">
                                                        <ul class="address-info address-info-2 p-0 text-dark">
                                                            ...
                                                            <li class="d-flex align-items-start">
                                                                ...
                                                                <div>
                                                                    <div class="short-description">
                                                                        <span>: <?php echo e(isset($translate[$lang]['address']) ? Str::limit($translate[$lang]['address'], 500) : ''); ?></span>
                                                                    </div>
                                                                    <div class="full-description display-none" >
                                        ...
                                        <div class="d-flex align-items-start">
                                            <button
                                                ...
                                                data-toggle="modal" data-target="#locationModal"><i
                                                    class="tio-poi"></i>
                                                <?php echo e(translate('messages.map_view')); ?></button>
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card __bg-FAFAFA border-0 h-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex gap-2 gap-sm-3 flex-wrap">
                                    <?php $__currentLoopData = $store->getPickupZones(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickupZone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="badge badge-soft-dark rounded-20 p-2 m-0 font-medium">
                                            <?php echo e($pickupZone->name ?? 'Unknown Zone'); ?>
                    ...
                    <div class="col-lg-12">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="resturant--info-address">
                                    <div class="pdf-single" data-pdf-url="<?php echo e($store->tin_certificate_image_full_url ?? asset('public/assets/admin/img/upload-cloud.png')); ?>">
                                         <div class="pdf-frame">
                                    ...
                                    <ul class="address-info address-info-2 list-unstyled list-unstyled-py-3 text-dark">
                                        <li>
                                            <span><strong><?php echo e(translate('Taxpayer Identification Number(TIN)')); ?>: </strong></span>
                                            <span class="pl-1"><?php echo e($store->tin); ?></span>
                                        </li>
                                        <li>
                                            <span><strong><?php echo e(translate('Expire Date')); ?>: </strong></span>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-title font-bold" id="locationModalLabel">
                        <?php echo e(translate($store->name)); ?></h3>
                ...
                <div class="modal-body">
                    <div class="d-flex gap-4 mb-20">
                        <div>
                            <span class="text-title font-medium"><?php echo e(translate('messages.Business Zone')); ?></span>
                            <div class="mt-10px">
                                <button class="btn btn--primary font-medium zone-btn business-zone-btn"
                                        id="businessZoneButton"
                                        data-zone="business">
                                    <?php echo e($store?->zone?->name); ?>

                                </button>
                            </div>
                        </div>
                        <div>
                            <span class="text-title font-medium"><?php echo e(translate('messages.Pickup Zone')); ?></span>
                            <div class="d-flex flex-wrap gap-10px mt-10px">
                                <?php $__currentLoopData = $store->getPickupZones(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickupZone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button class="btn btn--reset font-medium zone-btn pickup-zone-btn"
                                            id="pickupZoneButton<?php echo e($pickupZone->id); ?>"
                                            data-zone-id="<?php echo e($pickupZone->id); ?>"
                    ...
                    <form action="<?php echo e(route('admin.transactions.account-transaction.store')); ?>" method='post'
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="method" id="method" required maxlength="191"
                                   placeholder="<?php echo e(translate('messages.Ex_:_Card')); ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" min=".01" step="0.01" name="amount" id="amount"
                                   max="999999999999.99" placeholder="<?php echo e(translate('messages.Ex_:_1000')); ?>">
                        </div>
    ...
    <div class="d-none" id="data-set"
        ...
        data-store-transaction-url="<?php echo e(route('admin.transactions.account-transaction.store')); ?>"
        data-translate-transaction-saved="<?php echo e(translate('messages.transaction_saved')); ?>"

    ></div>

    <div id="mapContainer"
    data-business-coordinates='<?php echo json_encode($coordinates ?? [], 15, 512) ?>'
    data-business-center='{
        "lat": <?php echo e($store->latitude); ?>,
        "lng": <?php echo e($store->longitude); ?>

    }'
    data-marker-icon="<?php echo e(asset('public/assets/admin/img/zone-status-on.png')); ?>"
    data-pickup-zones='<?php echo json_encode($store->getPickupZones()->map(function($zone) {
        return [
            "id" => $zone->id, "coordinates" => json_decode($zone->coordinates[0]->toJson(), true)["coordinates"]
        ];
    })) ?>'
></div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/provider-overview.js')); ?>"></script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/provider/details/overview.blade.php ENDPATH**/ ?>