                        ...
                        <tbody id="set-rows">
                            <?php $__currentLoopData = $order_transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $ot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr scope="row">
                                    ...
                                    <td class="white-space-nowrap"><?php echo e(\App\CentralLogics\Helpers::format_currency($ot->net_non_delivery_commission - $ot->additional_charge - $ot->order['flash_admin_discount_amount'])); ?></td>
                                    ...
                                    <td class="white-space-nowrap"><?php echo e(\App\CentralLogics\Helpers::format_currency($ot->net_admin_commission - $ot->order['flash_admin_discount_amount'])); ?></td>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/report/day-wise-report.blade.php ENDPATH**/ ?>