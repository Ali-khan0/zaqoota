<?php $__env->startSection('title', translate('messages.Add New Driver')); ?>
                ...
                <div>
                    <h1 class="page-header-title text-break">
                        <span class="page-header-icon">
                            <img src="<?php echo e(asset('public/assets/admin/img/car-logo.png')); ?>" alt="<?php echo e(translate('image')); ?>">
                        </span>
                        <span><?php echo e(translate('messages.Add New Driver')); ?>
                        ...
                        <div class="card-body pb-2">
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                               for=""><?php echo e(translate('messages.Identity_Type')); ?></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" id="" name="identity_number" class="form-control"
                                               placeholder="<?php echo e(translate('Ex: 123654789512364')); ?>" value=""
                                               required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/view-pages/provider/driver-create.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/provider/driver/create.blade.php ENDPATH**/ ?>