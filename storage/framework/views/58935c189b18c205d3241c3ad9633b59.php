                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="d-none lang_form" id="<?php echo e($lang); ?>-form">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="meta_title[]"
                                                                id="<?php echo e($lang); ?>_title" maxlength="60"
                                                                class="form-control"
                                            ...
                                            <?php else: ?>
                                                <div id="default-form">
                                                    <div class="form-group">
                                                        <label class="input-label"
                                                            for="exampleFormControlInput1"><?php echo e(translate('messages.meta_title')); ?>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <textarea type="text" name="meta_description[]" placeholder="<?php echo e(translate('messages.meta_description')); ?>"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/zaqoota/resources/views/admin-views/vendor/view/meta-data.blade.php ENDPATH**/ ?>