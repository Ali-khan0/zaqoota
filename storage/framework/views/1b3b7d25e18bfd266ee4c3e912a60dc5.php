...
<?php $__env->startPush('css_or_js'); ?>
  <link rel="stylesheet" href="<?php echo e(asset('Modules/Rental/public/assets/css/admin/provider-edit.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div>
                    <h1 class="page-header-title text-break">
                        <span class="page-header-icon">
                            <img src="<?php echo e(asset('/public/assets/admin/img/rental/add_business_man_plus.png')); ?>" class="w--22" alt="">
                        </span>
                ...
                <div class="row g-2">
                        ...
                        <div class="card mt-4">
                            <div class="card-header">
                                <div>
                                    ...
                                    <p class="fs-12 mb-0">
                                        <?php echo e(translate('messages.Update the basic information of the provider ')); ?>
                                                        ...
                                                        <div class="lang_form"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name[]" id="default_name"
                                                                       class="form-control" placeholder="<?php echo e(translate('messages.provider_name')); ?>" value="<?php echo e($store->getRawOriginal('name')); ?>"
                                                                       required
                                                                >
                                                            </div>
                                                            ...
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <textarea type="text" name="address[]" placeholder="<?php echo e(translate('messages.provider address')); ?>" class="form-control min-h-90px ckeditor"><?php echo e($store->getRawOriginal('address')); ?></textarea>
                                                            </div>
                                                        </div>
                                                        <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                                                            ...
                                                            <div class="d-none lang_form"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name[]" id="<?php echo e($lang); ?>_name"
                                                                           class="form-control" value="<?php echo e($translate[$lang]['name']??''); ?>" placeholder="<?php echo e(translate('messages.provider_name')); ?>"
                                                                    >
                                                                </div>
                                                                ...
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <textarea type="text" name="address[]" placeholder="<?php echo e(translate('messages.provider address')); ?>" class="form-control min-h-90px ckeditor"><?php echo e($translate[$lang]['address']??''); ?></textarea>
                                                                </div>
                                                            </div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php else: ?>
                                                        <div id="default-form">
                                                            ...
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <textarea type="text" name="address[]" placeholder="<?php echo e(translate('messages.provider address')); ?>" class="form-control min-h-90px ckeditor"></textarea>
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    ...
                                    <p class="fs-12 mb-0">
                                        <?php echo e(translate('messages.Update the necessary information to operate the business')); ?>
                                ...
                                <div class="row g-3 my-0">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="zone_id" id="choice_zones" data-zone-coordinates-url="<?php echo e(route('admin.zone.get-coordinates', ['id' => 'PLACEHOLDER_ID'])); ?>" required
                                        ...
                                        <div class="form-group">
                                            <label class="input-label" for="latitude"><?php echo e(translate('messages.latitude')); ?>
                                                ...
                                                <span
                                                    class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('messages.provider_lat_lng_warning')); ?>">
                                                <img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.provider_lat_lng_warning')); ?>">
                                            </span>
                                            </label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    ...
                                    <p class="fs-12 mb-0">
                                        <?php echo e(translate('messages.Update the information of the Owner who operate the business')); ?>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    ...
                                    <p class="fs-12 mb-0">
                                        <?php echo e(translate('messages.Update the necessary information to account information')); ?>
                                    ...
                                    <div class="col-md-8 col-xxl-9">
                                        <div class="bg--secondary rounded p-20 h-100">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="date" name="tin_expire_date" class="form-control" value="<?php echo e($store->tin_expire_date); ?>" >
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="document-upload-wrapper d-none" id="doc-upload-wrapper">
                                                        ...
                                                        <div class="textbox">
                                                            <img width="40" height="40" class="svg"
                                                                 ...
                                                                 alt="">
                                                            <p class="fs-12 mb-0"><?php echo e(translate('messages.Select_a_file_or')); ?> <span class="font-semibold"><?php echo e(translate('messages.Drag & Drop')); ?></span>
                    ...
                    <div class="col-lg-12">
                        <div class="btn--container justify-content-end mt-20">
                            ...
                            <button type="submit"
                                    class="btn btn--primary min-w-100px justify-content-center"><?php echo e(translate('messages.update & next')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="d-none" id="data-set"
            ...
            data-store-lat="<?php echo e($store->latitude); ?>"
            data-store-lng="<?php echo e($store->longitude); ?>"
            data-store-name="<?php echo e($store->name); ?>"
            data-store-logo="<?php echo e($store->logo_full_url); ?>"
            data-store-cover-photo="<?php echo e($store->cover_photo_full_url); ?>"
            data-store-zone-id="<?php echo e($store->zone_id); ?>"
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/provider-edit.js')); ?>"></script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/provider/edit-basic-setup.blade.php ENDPATH**/ ?>