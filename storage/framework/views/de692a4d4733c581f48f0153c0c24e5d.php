            ...
            <div class="card-header border-0 align-items-center">
                <h4 class="card-title align-items-center gap-2">
                    <span class="card-header-icon">
                        <img src="<?php echo e(asset('public/assets/admin/img/store-3.png')); ?>" alt="">
                    </span>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/subscription/subscriber/vendor-subscription.blade.php ENDPATH**/ ?>