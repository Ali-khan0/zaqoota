    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a href="<?php echo e(route('admin.delivery-man.milestone-bonus')); ?>" class="btn btn--secondary"><?php echo e(translate('messages.back')); ?></a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/delivery-man/dm-milestone-bonus-awards.blade.php ENDPATH**/ ?>