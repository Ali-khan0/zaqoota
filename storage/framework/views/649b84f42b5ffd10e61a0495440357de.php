    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send_Mail_on_Unsuspend_a_Provider')); ?>

                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_Admin_unsuspend_a_provider,_the_provider_will_get_a_unsuspend_mail_from_the_system.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="<?php echo e(translate('Want_to_enable_Provider_unsuspend_mail?')); ?>"
                                data-title-off="<?php echo e(translate('Want_to_disable_Provider_unsuspend_mail?')); ?>"
                                data-text-on="<p><?php echo e(translate('If_enabled,_Provider_will_receive_an_email_for_account_unsuspension.')); ?></p>"
                                data-text-off="<p><?php echo e(translate('If_disabled,_Provider_will_not_receive_an_email_for_account_unsuspension.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.rental-email-status',['provider','unsuspend',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.rental-email-setup', ['provider','unsuspend'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
