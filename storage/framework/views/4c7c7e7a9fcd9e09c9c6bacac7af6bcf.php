    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.vehicle_reviews')); ?>
        ...
        <div class="card">
            ...
            <div class="card-header border-0 py-2">
                <h5 class="card-title">
                    <?php echo e(translate('messages.Review_list')); ?><span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($vehicleReview->total()); ?></span></h5>
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="<?php echo e(route('admin.rental.provider.vehicle.review.export', ['type' => 'excel', request()->getQueryString()])); ?>">
                            ...
                            <a id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.rental.provider.vehicle.review.export', ['type' => 'csv', request()->getQueryString()])); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                ...
                <div class="table-responsive datatable-custom">
                    <table id="columnSearchDatatable"
                        ...
                        <tr>
                            ...
                            <th class="w-30p text-center"><?php echo e(translate('messages.provider_reply')); ?></th>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <?php if($review->vehicle): ?>
                                        <a class="media align-items-center mb-1" href="<?php echo e(route('admin.rental.provider.vehicle.details', $review->vehicle_id)); ?>">
                                            <img class="avatar avatar-lg mr-3 onerror-image"
                                                 src="<?php echo e($review->vehicle['thumbnailFullUrl'] ?? asset('public/assets/admin/img/160x160/img2.jpg')); ?>"
                                                 data-onerror-image="<?php echo e(asset('public/assets/admin/img/160x160/img2.jpg')); ?>"
                                                 alt="<?php echo e($review->vehicle['name']); ?> image">
                                        </a>
                                        <div class="py-2">
                                            <a class="media align-items-center mb-1" href="<?php echo e(route('admin.rental.provider.vehicle.details', $review->vehicle_id)); ?>">
                                                <div class="media-body">
                                                    <h5 class="text-hover-primary mb-0"><?php echo e(Str::limit($review->vehicle['name'],20,'...')); ?></h5>
                                                </div>
                                            </a>
                                            <a class="mr-5 text-body" href="<?php echo e(route('admin.rental.trip.details', $review->trip_id)); ?>"> <?php echo e(translate('Trip_ID')); ?>: <?php echo e($review->trip_id); ?></a>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td>
                                    <label class="toggle-switch toggle-switch-sm" for="reviewCheckbox<?php echo e($review->id); ?>">
                                        <input type="checkbox"
                                               ...
                                               data-yes-text="<?php echo e(translate('messages.yes')); ?>"
                                               data-no-text="<?php echo e(translate('messages.no')); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.rental.provider.vehicle.review.status', $review['id'])); ?>" method="get" id="status-<?php echo e($review['id']); ?>">
                                    </form>
                                </td>
                            </tr>
...
<script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/vehicle-review-list.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/vehicle/review-list.blade.php ENDPATH**/ ?>