                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="text-center my-auto py-3">
                                <img class="img--100" id="viewer" src="<?php echo e(asset('public/assets/admin/img/400x400/img2.jpg')); ?>" alt="delivery-man image"/>
                            </div>
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/vendor-views/delivery-man/index.blade.php ENDPATH**/ ?>