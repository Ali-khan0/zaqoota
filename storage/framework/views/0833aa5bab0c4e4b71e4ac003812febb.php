                        ...
                        <div class="row g-xl-20 g-1">
                            <div class="col-xl-4 col-lg-6 col-6">
                                <div class="bg-ECEEF1 w-100 gallery-thumb-h-450 rounded-10">
                                    <img src="<?php echo e(asset('/public/assets/admin/img/400x400/ract-gallery1.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                </div>
                            </div>
                                ...
                                <div class="row g-xl-20 g-1">
                                    <div class="col-xl-6 col-6">
                                        <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/400x400/ract-gallery2.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-6">
                                        <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/400x400/ract-gallery3.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="bg-ECEEF1 w-100 gallery-thumb-h-220 rounded-10">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/400x400/ract-gallery4.jpg')); ?>" alt="" class="rounded-10 w-100 h-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/test/React_Landing/gallery-section.blade.php ENDPATH**/ ?>