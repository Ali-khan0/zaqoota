...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <?php echo $__env->make('rental::admin.business-settings.email-format-setting.partials.admin-email-template-setting-links', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintenancemode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Receive_Mail_On_‘New_Provider_Registration’?')); ?>

                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_a_provider_registers_from_the_customer_website_or_app_or_provider_app,_admin_will_receive_an_automated_email.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="<?php echo e(translate('Want_to_enable_Provider_Registration_mail?')); ?>"
                                       data-title-off="<?php echo e(translate('Want_to_disable_Provider_Registration_mail?')); ?>"
                                       data-text-on="<p><?php echo e(translate('If_enabled,_the_admin_will_get_an_automated_email_when_a_provider_registers.')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_the_admin_will_not_get_an_automated_email_when_a_provider_registers.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.rental-email-status',['admin','provider-registration',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.rental-email-setup', ['admin','provider-registration'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
