                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li
                                            class="nav-item <?php echo e(Request::is('admin/business-settings/pages/business-page/services-policy') ? 'active' : ''); ?>">
                                            <a class="nav-link "
                                                href="<?php echo e(route('admin.business-settings.services-policy')); ?>"
                                                title="<?php echo e(translate('messages.services_policy')); ?>">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate"><?php echo e(translate('messages.services_policy')); ?></span>
                                            </a>
                                        </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/layouts/admin/partials/_sidebar_settings.blade.php ENDPATH**/ ?>