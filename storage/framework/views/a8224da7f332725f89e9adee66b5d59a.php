...
<?php $__env->startSection('trip_tax_report'); ?>
    active
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <!--- Admin Tax Report -->
        <h2 class="mb-20"><?php echo e(translate('messages.Admin Trip Tax Report')); ?></h3>
            <div class="card p-20 mb-20">
                <div class="mb-20">
                    <h3 class="mb-1"><?php echo e(translate('messages.Admin Trip Tax Report')); ?></h3>
                    <p class="mb-1 fz-12">
                ...
                <span id="info_for_item">
                    <?php echo e(translate('Here you can see admin tax report only for Rental Module. You can view')); ?>

                    <a href="<?php echo e(route('admin.transactions.report.getTaxReport')); ?>"
                        class="font-semibold theme-clr text-decoration-underline"><?php echo e(translate('All Module Combine Tax Report')); ?>.</a>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column gap-lg-4 gap-3">
                                    ...
                                    <div class="<?php echo e($calculate_tax_on == 'individual_source' ? '' : 'd-none'); ?>"
                                        ...
                                        <span
                                            class="mb-2 d-block title-clr fw-normal"><?php echo e(translate('Tax on Trip Commission')); ?></span>
                    ...
                    <div class="search--button-wrapper justify-content-end">
                        ...
                        <div class="hs-unfold mr-2">
                            ...
                            <div id="usersExportDropdown__admin"
                                ...
                                <a id="export-excel" class="dropdown-item" href="<?php echo e(route('admin.transactions.rental.report.adminTaxReportExport',['export_type' => 'excel', request()->getQueryString()])); ?>">
                                ...
                                <a id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.transactions.rental.report.adminTaxReportExport',['export_type' => 'csv', request()->getQueryString()])); ?>">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a class="btn btn-sm theme-border action-btn theme-hover theme-clr" target="_blank"
                                                href="<?php echo e(route('admin.transactions.rental.report.getTaxDetails',['source'=> $key , request()->getQueryString()])); ?>">
                                ...
                                <tr>
                                    <td colspan="5" class="py-5">
                                        <div class="text-center max-w-700 mx-auto py-5">
                                            <img src="<?php echo e(asset('/public/assets/admin/img/tax-error.png')); ?>"
                                                alt="img" class="mb-20">
...
<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/admin-tax-report.js')); ?>"></script>
    <script>
        "use strict";
        ...
        $(document).on('ready', function() {
            ...
            Object.entries(selectedTax).forEach(([key, taxArray]) => {
                ...
                $select.select2({
                    ajax: {
                        url: '<?php echo e(route('admin.transactions.rental.report.getTaxList')); ?>',
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/report/tax-report/admin-tax-report.blade.php ENDPATH**/ ?>