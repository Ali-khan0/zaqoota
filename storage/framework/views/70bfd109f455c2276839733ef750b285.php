                    ...
                    <div class="card-body" id="form_data">
                        <form id="cashback-submit" action="" method="POST">
                            ...
                            <div class="row">
                                        ...
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo e(old('title.0')); ?>" name="title[]" maxlength="254" id="default_title"
                                                    class="form-control" placeholder="<?php echo e(translate('messages.Eid_Dhamaka')); ?>" required>
                                            </div>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6" id="customer_wise">
                                    <div class="form-group">
                                        ...
                                        <select required name="customer_id[]" id="select_customer"
                                            ...
                                            multiple="multiple" data-placeholder="<?php echo e(translate('messages.select_customer')); ?>" required>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.Min trip amount')); ?> (<?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?>)</label>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="1" required  value="<?php echo e(old('same_user_limit')); ?>" name="same_user_limit"  min="1" max="9999999" class="form-control"
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <?php $__currentLoopData = $cashBacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cashBack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                    <span class="d-block font-size-sm text-body" title="<?php echo e($cashBack['title']); ?>">
                                    <?php echo e(Str::limit($cashBack['title'],25,'...')); ?>

                                    </span>
                                    </td>


                                    <td><?php echo e(translate($cashBack['cashback_type'])); ?></td>
                                    <td> <?php echo e($cashBack['cashback_type'] == 'amount' ? \App\CentralLogics\Helpers::format_currency($cashBack['cashback_amount']) : $cashBack['cashback_amount'] .' %'); ?></td>
                                    <td> <?php echo e(\App\CentralLogics\Helpers::date_format($cashBack->start_date)); ?> -  <?php echo e(\App\CentralLogics\Helpers::date_format($cashBack->end_date)); ?></td>

                                    <td class="text-center"><?php echo e($cashBack['total_used']); ?></td>
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="bonusCheckbox<?php echo e($cashBack->id); ?>">
                                            <input type="checkbox" data-url="<?php echo e(route('admin.rental.cashback.status',[$cashBack['id'],$cashBack->status?0:1])); ?>" class="toggle-switch-input redirect-url" id="bonusCheckbox<?php echo e($cashBack->id); ?>" <?php echo e($cashBack->status?'checked':''); ?>>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            <a class="btn action-btn btn--primary btn-outline-primary" href="<?php echo e(route('admin.rental.cashback.edit',[$cashBack['id']])); ?>" title="<?php echo e(translate('messages.edit_cashback')); ?>"><i class="tio-edit"></i>
                                            </a>
                                            <a class="btn action-btn btn--danger btn-outline-danger form-alert" href="javascript:" data-id="bonus-<?php echo e($cashBack['id']); ?>" data-message="<?php echo e(translate('Want_to_delete_this_Cashback_?')); ?>" title="<?php echo e(translate('messages.delete_bonus')); ?>"><i class="tio-delete-outlined"></i>
                                            </a>
                                            <form action="<?php echo e(route('admin.rental.cashback.delete',[$cashBack['id']])); ?>"
                                            method="post" id="bonus-<?php echo e($cashBack['id']); ?>">
...
<script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/cashback-list.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/cashback/list.blade.php ENDPATH**/ ?>