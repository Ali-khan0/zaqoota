...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <?php echo $__env->make('rental::admin.business-settings.email-format-setting.partials.user-email-template-setting-links', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                <?php echo e(translate('Send_Mail_On_‘Trip_Booking’?')); ?>

                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Customers_will_receive_an_automated_email_after_a_successful_Trip_Booking.')); ?>">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="<?php echo e(translate('Want_to_enable_Trip_Booking_mail?')); ?>"
                                       data-title-off="<?php echo e(translate('Want_to_disable_Trip_Booking_mail?')); ?>"
                                       data-text-on="<p><?php echo e(translate('If_enabled,_customers_will_get_an_automatic_confirmation_mail_for_successful_Trip_Booking_with_an_invoice')); ?></p>"
                                       data-text-off="<p><?php echo e(translate('If_disabled,_customers_will_NOT_get_any_Trip_Booking_email.')); ?></p>"
                        ...
                        <form action="<?php echo e(route('admin.business-settings.rental-email-status',['user','place-order',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                                            </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.rental-email-setup', ['user','new-order'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                        ...
                                        <?php if($language): ?>
                                            <div class="__bg-F8F9FC-card default-form lang_form" id="default-form">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title[]" value="<?php echo e($data?->getRawOriginal('title')); ?>" data-id="mail-title" placeholder="Trip has been placed successfully !" class="form-control">
                                                </div>
                                            ...
                                            if($data && count($data['translations'])){
                                                ...
                                                <div class="__bg-F8F9FC-card d-none lang_form" id="<?php echo e($lang); ?>-form">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title[]" placeholder="Trip has been placed successfully !" class="form-control" value="<?php echo e($translate[$lang]['title']??''); ?>">
                                                    </div>
                                                    <div class="form-group mb-0">
                                                        <label class="form-label">
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    <?php if($language): ?>
                                                        <div class="form-group m-0 lang_form default-form">
                                                            ...
                                                            <input type="text" data-id="mail-button" name="button_name[]"  placeholder="<?php echo e(translate('Ex: Trip now')); ?>" class="form-control h--45px" value="<?php echo e($data?->getRawOriginal('button_name')); ?>">
                                                        </div>
                                                    <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    if($data && count($data['translations'])){
                                                        ...
                                                        <div class="form-group m-0 d-none lang_form" id="<?php echo e($lang); ?>-form1">
                                                            ...
                                                            <input type="text" name="button_name[]"  placeholder="<?php echo e(translate('Ex: Trip now')); ?>" class="form-control h--45px" value="<?php echo e($translate[$lang]['button_name']??''); ?>">
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                                <div class="form-group m-0">
                                                    ...
                                                    <input type="text" placeholder="<?php echo e(translate('Ex: Trip now')); ?>" class="form-control h--45px" name="button_name[]" value="">
                                                </div>
                                                <?php endif; ?>
                                                </div>
                                                <div class="col-sm-6">
