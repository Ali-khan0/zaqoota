...
<div class="content container-fluid">
    <div class="d-flex align-items-center mb-20 gap-2">
        <img width="22" height="22" src="<?php echo e(asset('public/assets/admin/img/d-withdraw.png')); ?>"
                        ...
                        <td class="px-3 py-4">
                            <div>
                                <a href="javascript:void(0)" class="d-flex align-items-center gap-2">
                                    <img width="40" height="40" src="<?php echo e(asset('public/assets/admin/img/160x160/img1.jpg')); ?>" alt="img" class="w-40px h-40px rounded-circle">
                                    <div class="info">
        ...
        <div class="modal-content pb-2 max-w-500">
            ...
            <div class="modal-body">
                <div class="text-center max-w-320 mx-auto">
                    <img src="<?php echo e(asset('public/assets/admin/img/feature-status-on.png')); ?>" alt="icon" class="mb-3">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/test/deliveryman-withdraw-transaction.blade.php ENDPATH**/ ?>