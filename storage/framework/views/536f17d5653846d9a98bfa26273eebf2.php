                                ...
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <span>Bkash</span>
                                            <img class="ml-auto" src="<?php echo e(asset('/public/assets/admin/img/bkash1.png')); ?>" width="30" alt="">
                                        </div>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <img class="ml-auto" src="<?php echo e(asset('/public/assets/admin/img/marcado1.png')); ?>" width="30" alt="">
                                        </div>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <img class="ml-auto" src="<?php echo e(asset('/public/assets/admin/img/sslcomz1.png')); ?>" width="60" alt="">
                                        </div>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label class="payment-item">
                                        ...
                                        <div class="payment-item-inner">
                                            ...
                                            <span>PayStack</span>
                                            <img class="ml-auto" src="<?php echo e(asset('/public/assets/admin/img/paystack1.png')); ?>" width="30" alt="">
                                        </div>
                                    </label>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/subscription/subscription-in-store-details.blade.php ENDPATH**/ ?>