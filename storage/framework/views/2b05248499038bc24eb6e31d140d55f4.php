...
<div class="content container-fluid">
            ...
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills mb-2">
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-title"
                        href="<?php echo e(route('admin.rental.settings.down_app')); ?>"><?php echo e(translate('messages.Download App')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-title active"
                        href="javascript:"><?php echo e(translate('messages.Vendors Registration')); ?></a>
                </li>
            </ul>
            <!-- End Nav -->
        </div>
    ...
    <form action="<?php echo e(route('admin.rental.settings.vendors_registration_update')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                            ...
                            <div class="lang_form" id="default-form">
                                ...
                                <div class="form-group mb-20">
                                    ...
                                    <div class="character-count">
                                        ...
                                        data-max-character="110"><?php echo e($sub_title_data?->getRawOriginal('value')); ?></textarea>
                                        <span class="d-flex text-count justify-content-end"></span>
                                    </div>
                                ...
                                <div class="form-group mb-0">
                                    <label class="input-label font-semibold"
                                        for="exampleFormControlInput1"><?php echo e(translate('messages.button_title')); ?>

                                        (<?php echo e(translate('messages.default')); ?>)
                                    </label>
                                        <div class="character-count">
                                            <textarea type="text" name="button_title[]" placeholder="<?php echo e(translate('messages.type_button_title')); ?>"
                                            class="form-control character-count-field h--45px" maxlength="20"
                                            data-max-character="20"><?php echo e($button_title_data?->getRawOriginal('value')); ?></textarea>
                                            <span class="d-flex text-count justify-content-end"></span>
                                        </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group mb-20">
                                        ...
                                        <div class="character-count">
                                            <input type="text" name="title[]" id="<?php echo e($lang); ?>_name"
                                                ...
                                                value="<?php echo e($title_data_translate[$lang]['value']?? ''); ?>"
                                    ...
                                    <div class="form-group mb-20">
                                        <label class="input-label font-semibold"
                                            ...
                                            <div class="character-count">
                                                <textarea type="text" name="sub_title[]" placeholder="<?php echo e(translate('messages.type_subtitle')); ?>"
                                                    class="form-control character-count-field" maxlength="110"
                                                    data-max-character="110"><?php echo e($sub_title_data_translate[$lang]['value']?? ''); ?></textarea>
                                                <span class="d-flex text-count justify-content-end"></span>
                                            </div>
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label font-semibold"
                                            ...
                                            <div class="character-count">
                                                <textarea type="text" name="button_title[]" placeholder="<?php echo e(translate('messages.type_button_title')); ?>"
                                                class="form-control character-count-field h--45px" maxlength="20"
                                                data-max-character="20"><?php echo e($button_title_data_translate[$lang]['value']?? ''); ?></textarea>
                                                <span class="d-flex text-count justify-content-end"></span>
                                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="d-flex flex-column justify-content-between h-100">
                            <div class="text-center">
                                ...
                                <div class="mb-20">
                                    <p class="fs-12">
                                        <?php echo e(translate('JPG, JPEG, PNG Less Than 1MB')); ?> <strong class="font-semibold">(Ratio 3:2)</strong>
                                    </p>
                                </div>
                                ...
                                <div class="upload-file image-general d-inline-block w-auto">
                                    ...
                                    <label
                                        ...
                                        <img class="upload-file-img d-none aspect-3-2" data-src="<?php echo e($image?->value ?  \App\CentralLogics\Helpers::get_full_url('react_landing', $image?->value?? '', $image?->storage[0]?->value ?? 'public','upload_image_1' ) : ''); ?>" height="200" width="264" loading="lazy"  src="<?php echo e($image?->value ?  \App\CentralLogics\Helpers::get_full_url('react_landing', $image?->value?? '', $image?->storage[0]?->value ?? 'public','upload_image_1' ) : ''); ?>" alt="">
                                    </label>
                                </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/home-page-setup/vendor-registration.blade.php ENDPATH**/ ?>