                ...
                <div class="row g-lg-4 g-3">
                    <div class="col-md-6 col-xl-3">
                        <div class="bg-opacity-warning-5 h-100 rounded p-24">
                            <img src="<?php echo e(asset('/public/assets/admin/img/tax/1.png')); ?>" alt="img" class="mb-20">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="bg-opacity-primary-5 h-100 rounded p-24">
                            <img src="<?php echo e(asset('/public/assets/admin/img/tax/2.png')); ?>" alt="img" class="mb-20">
                    ...
                    <div class="col-lg-12 col-xl-6">
                        <div class="bg-opacity-warning-5 h-100 rounded p-24 d-flex flex-sm-nowrap flex-wrap gap-3">
                            <div class="w-xxl-100 w-sm-50">
                                <img src="<?php echo e(asset('/public/assets/admin/img/tax/3.png')); ?>" alt="img" class="mb-20">
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/vendor-views/report/tax-report/vendor-tax-detail-report.blade.php ENDPATH**/ ?>