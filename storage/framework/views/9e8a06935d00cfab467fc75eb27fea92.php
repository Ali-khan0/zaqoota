                                ...
                                <div class="items__">
                                    <div class="px-3 py-4 shadow--card d-flex align-items-center gap-3">
                                        <div class="thumb-area bg-F5F5F5 rounded-pill w-60px h-60px min-w-60px d-center">
                                            <img wdith="28" height="28" src="<?php echo e(asset('/public/assets/admin/img/order-delivery-list.png')); ?>" alt="" class="min-w-28">
                                        </div>
                                        <div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/test/React_Landing/trust-section.blade.php ENDPATH**/ ?>