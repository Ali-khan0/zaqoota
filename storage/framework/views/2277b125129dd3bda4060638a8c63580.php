                        ...
                        <div class="clients-preview-slide owl-theme owl-carousel">
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide1.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide2.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide3.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide4.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide5.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide6.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide7.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                            <div class="items__">
                                <div class="p-xxl-3 p-2 d-center h-135px bg--secondary rounded">
                                    <img wdith="110" height="100" src="<?php echo e(asset('/public/assets/admin/img/400x400/react-new-slide8.jpg')); ?>" alt="" class="rounded">                                                                       
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/test/React_Landing/popular-clients.blade.php ENDPATH**/ ?>