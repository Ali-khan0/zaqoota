...
<?php $__env->startSection('content'); ?>
    ...
    <form class="js-validate" action="<?php echo e(route('restaurant.store')); ?>" method="post" enctype="multipart/form-data"
        id="form-id">
        <?php echo csrf_field(); ?>
        <div class="card __card mb-3">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    </svg> <?php echo e(translate('messages.vendor_info')); ?>
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" id="default_name" class="form-control __form-control"
                                        placeholder="<?php echo e(translate('messages.vendor_name')); ?>" required>
                                </div>
                            </div>
                            <input type="hidden" name="lang[]" value="default">
                            <div class="mb-4">
                                <div class="form-group mb-0">
                                    <label class="input-label" for="address"><?php echo e(translate('messages.address')); ?> (<?php echo e(translate('messages.default')); ?>)</label>
                        ...
                        <div class="d-none lang_form" id="<?php echo e($lang); ?>-form">
                            <div class="mb-4">
                                <div class="form-group">
                                    <label class="input-label" for="<?php echo e($lang); ?>_name"><?php echo e(translate('messages.name')); ?>
                            ...
                            <div class="mb-4">
                                <div class="form-group mb-0">
                                    <label class="input-label" for="address<?php echo e($lang); ?>"><?php echo e(translate('messages.address')); ?>

                                        (<?php echo e(strtoupper($lang)); ?>)</label>
                                    <textarea type="text" id="address<?php echo e($lang); ?>" name="address[]"
                                        placeholder="<?php echo e(translate('Ex: ABC Company')); ?>"
                                        class="form-control __form-control h-120"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="form-group mb-4">
                            <label for="module_id" class="input-label"><?php echo e(translate('messages.module')); ?> <small class="text-danger">(<?php echo e(translate('messages.Select_zone_first')); ?>)</small></label>
                        ...
                        <div class="form-group mb-4">
                            <label class="input-label" for="latitude"><?php echo e(translate('messages.latitude')); ?> <span
                                    ...
                                    title="<?php echo e(translate('messages.vendor_lat_lng_warning')); ?>"><img
                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                        alt="<?php echo e(translate('messages.vendor_lat_lng_warning')); ?>"></span></label>
                            <input type="text" id="latitude" name="latitude" class="form-control __form-control"
                                placeholder="<?php echo e(translate('messages.Ex:')); ?> -94.22213" value="<?php echo e(old('latitude')); ?>"
                                required readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            <div class="form-group">
                                <label class="input-label"
                                    for="minimum_delivery_time"><?php echo e(translate('messages.approx_delivery_time')); ?></label>
                        ...
                        <div class="d-flex gap-4">
                            <div class="form-group w-140px flex-grow-1 d-flex flex-column justify-content-between">
                                <label class="input-label pt-2"><?php echo e(translate('Upload Cover Photo')); ?><small class="text-danger">
                                    * (<?php echo e(translate('messages.ratio')); ?> 2:1 )</small>
                                </label>
                                <label class="image--border position-relative">
                                    <img class="__register-img" id="coverImageViewer"
                                        src="<?php echo e(asset('public/assets/admin/img/upload-img.png')); ?>" alt="Product thumbnail" />
                            ...
                            <div class="form-group w-140px d-flex flex-column justify-content-between">
                                <label class="input-label pt-2"><?php echo e(translate('messages.vendor_logo')); ?><small class="text-danger">
                                        * (
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="l_name" name="l_name" class="form-control __form-control"
                                placeholder="<?php echo e(translate('messages.last_name')); ?>" value="<?php echo e(old('l_name')); ?>"
                                required>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12">
        ...
        <div class="card __card bg-F8F9FC mb-3">
            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    <div class="col-md-4 col-sm-12 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control __form-control"
                                placeholder="<?php echo e(translate('messages.Ex:')); ?> ex@example.com" value="<?php echo e(old('email')); ?>"
                                required>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-lg-4">
                        <div class="form-group">
                            <label class="input-label" for="exampleInputPassword"><?php echo e(translate('messages.password')); ?>
                            ...
                            <label class="position-relative m-0 d-block">
                                <input type="password" name="password"
                                    ...
                                    id="exampleInputPassword" required value="<?php echo e(old('password')); ?>">
                    ...
                    <div class="col-md-4 col-sm-12 col-lg-4">
                        <div class="form-group">
                            <label class="input-label" for="exampleRepeatPassword"><?php echo e(translate('messages.confirm_password')); ?></label>
                            <label class="position-relative m-0 d-block">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6 recap-img-div">
                                    <img src="<?php echo $custome_recaptcha->inline() ?? ''; ?>" alt="image"
                                        class="recap-img" />
                                </div>
                            </div>
                            <?php endif; ?>
        ...
        <div class="text-end pt-3">
            <button type="submit" class="cmn--btn rounded-md border-0 outline-0"><?php echo e(translate('messages.submit')); ?></button>
        </div>
        </div>
    </form>
        </div>
    ...
    <?php $__env->startPush('script_2'); ?>
        ...
        <script src="<?php echo e(asset('public/assets/admin/js/view-pages/vendor-registration.js')); ?>"></script>
            <?php if(isset($recaptcha) && $recaptcha['status'] == 1): ?>
                ...
                <script type="text/javascript">
                    // reCAPTCHA v3 has no widget; we generate token on submit.
                </script>
...
<?php echo $__env->make('layouts.landing.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/vendor-views/auth/register.blade.php ENDPATH**/ ?>