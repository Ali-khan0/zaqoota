            ...
            <div class="d-flex justify-content-between flex-wrap gap-3">
                <div>
                    <h1 class="page-header-title text-break">
                        ...
                        <span><?php echo e(translate('messages.vehicle_list')); ?></span>
                    </h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="select-item">
                                ...
                                <select id="brand-select" class="select-30 js-data-example-ajax form-control set-filter opacity-70"
                                        name="brand_id">
                                    <option value="" selected disabled><?php echo e(translate('messages.select_vehicle_brand')); ?>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="select-item">
                                ...
                                <select id="type-select" class="js-data-example-ajax form-control set-filter opacity-70"
                                    ...
                                    <option value="family" <?php echo e(request()->vehicle_type == 'family' ? 'selected' : ''); ?>><?php echo e(translate('messages.family')); ?></option>
                                    <option value="luxury" <?php echo e(request()->vehicle_type == 'luxury' ? 'selected' : ''); ?>><?php echo e(translate('messages.Luxury')); ?></option>
                                    <option value="affordable" <?php echo e(request()->vehicle_type == 'affordable' ? 'selected' : ''); ?>><?php echo e(translate('messages.Affordable')); ?></option>
                                    <option value="executives" <?php echo e(request()->vehicle_type == 'executives' ? 'selected' : ''); ?>><?php echo e(translate('messages.Executives')); ?></option>
                                    <option value="compact" <?php echo e(request()->vehicle_type == 'compact' ? 'selected' : ''); ?>><?php echo e(translate('messages.Compact')); ?></option>
                                    <option value="full-size" <?php echo e(request()->vehicle_type == 'full-size' ? 'selected' : ''); ?>><?php echo e(translate('messages.Full-Size')); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12">
            ...
            <div class="card-header py-2">
                <div class="search--button-wrapper">
                    ...
                    "type": "css-animation"
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                               href="<?php echo e(route('admin.rental.provider.vehicle.export', ['type' => 'excel', request()->getQueryString()])); ?>">
                            ...
                            <a id="export-csv" class="dropdown-item"
                               href="<?php echo e(route('admin.rental.provider.vehicle.export', ['type' => 'csv', request()->getQueryString()])); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <a class="btn btn--primary font-weight-bold float-right mr-2 mb-0"
                       href="<?php echo e(route('admin.rental.provider.vehicle.create')); ?>"><?php echo e(translate('messages.new_vehicle')); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text--title">
                                    <a href="<?php echo e(route('admin.rental.provider.vehicle.details', $vehicle->id)); ?>?vehicle_list=true" class="font-medium">
                            ...
                            <td>
                                <div class="text--title">
                                    <a href="<?php echo e(route('admin.rental.provider.details', $vehicle->provider_id)); ?>" class="font-medium">
                                        <?php echo e($vehicle?->provider?->name ?? translate('provider_not_found')); ?>

                                    </a>
                                    <div class="opacity-lg">
                                        <?php echo e($vehicle?->provider?->email); ?>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn action-btn btn--primary btn-outline-primary" href="<?php echo e(route('admin.rental.provider.vehicle.details', $vehicle->id)); ?>?vehicle_list=true"
...
<script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/vehicle-list.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/vehicle/list.blade.php ENDPATH**/ ?>