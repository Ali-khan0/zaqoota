                                ...
                                <label class="__upload-img aspect-235-375 m-auto d-block position-relative">
                                    ...
                                    <?php if(isset($best_reviewed_section_banner?->value)): ?>
                                        <span id="best_reviewed_section_banner" class="remove_image_button dynamic-checkbox"
                                            ...
                                            data-image-on='<?php echo e(asset('/public/assets/admin/img/modal')); ?>/mail-success'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/admin-views/other-banners/ecommerce-index.blade.php ENDPATH**/ ?>