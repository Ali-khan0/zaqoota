    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
                ...
                <div class="px-xl-2 pb-sm-3">
                    <div class="row g-4 g-md-5">
                        ...
                        <?php $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($key != 'db_file_write_perm' && $key != 'routes_file_write_perm'): ?>
                                <div class="col-md-6">
                                    <div class="d-flex gap-3 align-items-center">
                                        <img src="<?php echo e(asset('public/assets/installation')); ?>/assets/img/svg-icons/curl-enabled.svg" alt="">
                                        <div class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                            <?php echo e(translate($key) . ' ' . translate('Enabled')); ?>


                                            <?php if($item): ?>
                                                <img width="20" src="<?php echo e(asset('public/assets/installation')); ?>/assets/img/svg-icons/check.png" alt="">
                                            <?php else: ?>
                                                <span class="cursor-pointer" data-bs-toggle="tooltip"
                                                      data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                      data-bs-html="true" data-bs-delay='{"hide":1000}'
            ...
            <div class="text-center">
                ...
                <?php if($permission['curl_enabled'] == 1 && $permission['db_file_write_perm'] == 1 && $permission['routes_file_write_perm'] == 1 && $phpVersion >= 8.2): ?>
                    <a href="<?php echo e(route('step3',['token'=>bcrypt('step_3')])); ?>" class="btn btn-dark px-sm-5">Proceed
                        Next</a>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.blank', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/installation/step1.blade.php ENDPATH**/ ?>