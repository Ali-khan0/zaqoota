<?php $__env->startSection('title', translate('Admin Trip Tax Report')); ?>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-15">
                    ...
                    <div class="hs-unfold mr-2 hungar-export">
                        ...
                        <div id="usersExportDropdown4"
                            ...
                            <a id="export-excel" class="dropdown-item" href="<?php echo e(route('admin.transactions.rental.report.getTaxDetailsExport',['source'=> $taxSource ,'export_type' => 'excel', request()->getQueryString()])); ?>">
                            ...
                            <a id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.transactions.rental.report.getTaxDetailsExport',['source'=> $taxSource ,'export_type' => 'csv', request()->getQueryString()])); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            <?php echo e(translate('Total_Trips')); ?> <h4 class="theme-clr fw-bold mb-0"><?php echo e($total_count); ?>
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            <?php echo e(translate('Total_Trip_Amount')); ?> <h4 class="theme-clr fw-bold mb-0">
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0"><?php echo e(translate('Trip')); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $taxData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <h6><?php echo e(\App\CentralLogics\Helpers::format_currency($item->trip_amount)); ?></h6>
                                         <small>#<?php echo e($item->trip_id); ?> </small>
                                    </td>
                                    <td>
                                        <?php if($taxSource =='admin_commission' ): ?>
                                        <?php echo e(\App\CentralLogics\Helpers::format_currency($item->admin_commission)); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/report/tax-report/admin-tax-report-details.blade.php ENDPATH**/ ?>