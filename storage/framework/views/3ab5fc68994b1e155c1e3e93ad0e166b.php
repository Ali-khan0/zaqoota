...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.rental.notification.update',[$notification['id']])); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                        <div class="col-lg-6">
                            <div class="row g-2">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="tergat" class="form-control" id="tergat" data-placeholder="<?php echo e(translate('messages.select_tergat')); ?>" required>
                                            ...
                                            <option value="store" <?php echo e($notification->tergat=='provider'?'selected':''); ?>><?php echo e(translate('messages.provider')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="col-lg-6">
                            <div class="h-100 d-flex flex-column">
                                ...
                                <div class="text-center py-3 my-auto">
                                    ...
                                    src="<?php echo e($notification['image_full_url']); ?>" data-src="<?php echo e($notification['image_full_url']); ?>"
...
<input type="hidden" id="default_zone_id" value="<?php echo e($notification['zone_id']); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/push-notification-edit.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/push-notification/edit.blade.php ENDPATH**/ ?>