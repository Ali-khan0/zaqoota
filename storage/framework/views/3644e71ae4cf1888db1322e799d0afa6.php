                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="<?php echo e(route('vendor.vehicle.review.export', ['type' => 'excel', request()->getQueryString()])); ?>">
                            ...
                            <a id="export-csv" class="dropdown-item" href="<?php echo e(route('vendor.vehicle.review.export', ['type' => 'csv', request()->getQueryString()])); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <?php if($review->vehicle): ?>
                                        <a class="media align-items-center mb-1" href="<?php echo e(route('vendor.vehicle.details', $review->vehicle_id)); ?>">
                                ...
                                <td>
                                    <label class="toggle-switch toggle-switch-sm" for="reviewCheckbox<?php echo e($review->id); ?>">
                                        <input type="checkbox"
                                               ...
                                               data-alert="<?php echo e(translate('are_you_sure')); ?>"
                                    ...
                                    <form action="<?php echo e(route('vendor.vehicle.review.status', $review['id'])); ?>" method="get" id="status-<?php echo e($review['id']); ?>">
                                    </form>
                                </td>
                            </tr>
...
<?php $__env->startPush('script_2'); ?>
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/view-pages/provider/vehicle-review-list.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/provider/vehicle/review-list.blade.php ENDPATH**/ ?>