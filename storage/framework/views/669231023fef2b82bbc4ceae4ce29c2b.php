            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.business-settings.rental-email-status',['user','refund-order',$mail_status == '1'?0:1])); ?>" method="get" id="mail-status_form">
                                            </form>
                    </div>
                </div>
                ...
                <form action="<?php echo e(route('admin.business-settings.rental-email-setup', ['user','refund-order'])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
