...
<?php $__env->startPush('css_or_js'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('Modules/Rental/public/assets/css/admin/vehicle-details.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex align-items-start flex-wrap gap-2">
                    ...
                    <form action="<?php echo e(route('admin.rental.provider.vehicle.delete',[$vehicle['id']])); ?>?vehicle_list=<?php echo e(request()->vehicle_list); ?>&provider_id=<?php echo e(request()->provider_id); ?>&provider_vehicle_list=<?php echo e(request()->provider_vehicle_list); ?>" method="post" id="vehicle-<?php echo e($vehicle->id); ?>">
                    ...
                    <a href="<?php echo e(route('admin.rental.provider.vehicle.edit', $vehicle->id)); ?>" class="btn btn--primary h--45px d-flex gap-2 align-items-center">
                        <i class="tio-edit"></i>
                        ...
                        <div>
                            ...
                            <?php if($language): ?>
                                <div class="lang_form text--title" id="default-form">
                                    ...
                                    <h5 class="text--title font-semibold opacity-lg mb-10px"><?php echo e(translate('Description')); ?>:</h5>
                                    <div class="fs-12 opacity-lg description-text">
                                        <span class="short-description">
                                            <?php echo e(Str::limit($vehicle?->getRawOriginal('description'), 1500)); ?>

                                        </span>
                                                                            <span class="full-description display-none" >
                                            <?php echo e($vehicle?->getRawOriginal('description')); ?>

                                        </span>
                                        <!-- By default, "See more" button is hidden -->
                                        <a href="#" class="text--info font-medium see-more display-none" >
                                            <?php echo e(translate('See more')); ?>
                                ...
                                <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="lang_form d-none text--title" id="<?php echo e($lang); ?>-form">
                                        ...
                                        <div class="fs-12 opacity-lg description-text">
                                                <span class="short-description">
                                                    <?php echo e(Str::limit($vehicle?->getRawOriginal('description'), 2100)); ?>
            ...
            <div class="col-lg-3 mb-20 mb-lg-0">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <a class="resturant--information-single" href="<?php echo e(route('admin.rental.provider.details', $vehicle->provider_id)); ?>">
                            <img class="img--65 rounded mx-auto mb-3 onerror-image" data-onerror-image=""
                                 src="<?php echo e($vehicle?->provider?->logoFullUrl ?? asset('public/assets/admin/img/100x100/1.png')); ?>" alt="Image Description">
                            <div class="text-center text--title">
                                ...
                                <span class="opacity-lg">
                                    <?php echo e(Str::limit($vehicle?->provider?->address, 40)); ?>
                        ...
                        <table id="" class="table table-borderless table-thead-bordered table-nowrap card-table">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <div class="d-flex">
                                            <span class="min-w-110px"><?php echo e(translate('Brand')); ?></span>
                                            <span class="font-semibold">: <?php echo e(Str::limit($vehicle?->brand?->name, 15)); ?></span>
                                        </div>

                                        <div class="d-flex">
                                            <span class="min-w-110px"><?php echo e(translate('Category')); ?></span>
                                            <span class="font-semibold">: <?php echo e(Str::limit($vehicle?->category?->name, 15)); ?></span>
                                        </div>
                                        <div class="d-flex"><span class="min-w-110px"><?php echo e(translate('Type')); ?></span><span
                                                class="font-semibold">: <?php echo e(translate($vehicle?->type)); ?></span></div>
                                    </div>
                                </td>
                                <td>
                                    <div>
                                    ...
                                    <div class="d-flex justify-content-between gap-20px">
                                        <div>
                                            ...
                                            <div class="d-flex"><span class="min-w-110px"><?php echo e(translate('Transmission')); ?></span><span
                                                    class="font-semibold">:
                                                        <?php echo e(str_replace('_', ' ', translate($vehicle->transmission_type))); ?></span></div>
                                            <div class="d-flex"><span class="min-w-110px"><?php echo e(translate('Fuel Type')); ?></span><span
                                                    class="font-semibold">: <?php echo e(translate($vehicle->fuel_type)); ?></span></div>
                                        </div>
                                        <div>
        ...
        <div class="card">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                               href="<?php echo e(route('admin.rental.provider.vehicle.review.export', ['vehicle_id' => request()->id, 'type' => 'excel', request()->getQueryString()])); ?>">
                            ...
                            <a id="export-csv" class="dropdown-item"
                               href="<?php echo e(route('admin.rental.provider.vehicle.review.export', ['vehicle_id' => request()->id, 'type' => 'csv', request()->getQueryString()])); ?>">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tbody id="set-rows">
                    <?php $__currentLoopData = $vehicleReview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                                ...
                                <div class="table-rest-info d-block">
                                    <div class="info">
                                        <div title="Car Rental Service" class="text--info">
                                            <?php echo e($review->customer->fullName); ?>

                                        </div>
                                        <div>
                                                <span class="font-light">
                                                    <?php echo e($review->customer->phone); ?>
                            ...
                            <td>
                                <?php echo e($review->reviewDate); ?>

                                <br>
                                <?php echo e($review->reviewTime); ?>

                            </td>
                            <td>
                                <div class="line--limit-2 max-w--220px">
                                    <?php echo e($review->reply ? $review->reply : 'N/A'); ?>

                                </div>
                            <td>
                                <label class="toggle-switch toggle-switch-sm" for="publishCheckbox<?php echo e($review->id); ?>">
                                    <input type="checkbox" data-url="<?php echo e(route('admin.rental.provider.vehicle.review.status', $review->id)); ?>" class="toggle-switch-input redirect-url"
                                           id="publishCheckbox<?php echo e($review->id); ?>" <?php echo e($review->status ? 'checked' : ''); ?>>
    ...
    <div id="file-assets"
        ...
        data-document-path="<?php echo e(asset('public/assets/admin/img/icons')); ?>"
        data-default-thumbnail="<?php echo e(asset('public/assets/admin/img/blank2.png')); ?>">
    </div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('Modules/Rental/public/assets/js/admin/view-pages/vehicle-details.js')); ?>"></script>


<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/vehicle/details.blade.php ENDPATH**/ ?>