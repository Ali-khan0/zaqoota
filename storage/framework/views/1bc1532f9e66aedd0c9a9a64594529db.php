                                ...
                                <div class="d-flex flex-column align-items-center gap-3 flex-shrink-0">
                                    ...
                                    <div class="upload-file">
                                        ...
                                        <div class="upload-file__img">
                                            <img src="<?php echo e($advertisement?->profile_image_full_url); ?>" data-src="<?php echo e(asset('public/assets/admin/img/media/upload-file.png')); ?>" alt="" >
                                        </div>
                                        <button class="remove-file-button" type="button">
                                            <i class="tio-clear"></i>
                                        </button>
                                ...
                                <div class="d-flex flex-column align-items-center gap-3">
                                    ...
                                    <div class="upload-file">
                                        ...
                                        <div class="upload-file__img upload-file__img_banner aspect-2-1">
                                            <img src="<?php echo e($advertisement?->cover_image_full_url); ?>" data-src="<?php echo e(asset('public/assets/admin/img/media/banner-upload-file.png')); ?>" alt="" >
                                        </div>
                                        <button class="remove-file-button" type="button">
                                            <i class="tio-clear"></i>
                                        </button>
...
<?php echo $__env->make('layouts.vendor.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/resources/views/vendor-views/advertisement/edit.blade.php ENDPATH**/ ?>