    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.vehicle_bulk_import')); ?>
            ...
            <div class="card-body">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        <a href="<?php echo e(asset('public/assets/vehicle_bulk_format.xlsx')); ?>" download="" class="btn btn--primary btn-outline-primary"><?php echo e(translate('With Current Data')); ?></a>
                        <a href="<?php echo e(asset('public/assets/vehicle_bulk_format_nodata.xlsx')); ?>" download="" class="btn btn--primary"><?php echo e(translate('Without Any Data')); ?></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mt-2 rest-part">
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            <h5 class="text-capitalize mb-3"><?php echo e(translate('Import_vehicle_file')); ?></h5>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ali/Documents/xaqoota/vps_backup_before_the_migration/zaqoota/Modules/Rental/Resources/views/admin/vehicle/bulk-import.blade.php ENDPATH**/ ?>