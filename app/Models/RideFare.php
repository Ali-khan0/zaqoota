...
class RideFare extends Model
{
    protected $fillable = [
        ...
        'cancellation_charge', 'platform_commission_percent', 'negotiation_min_percent',
        'negotiation_max_percent', 'surge_enabled', 'surge_multiplier', 'status',
    ];
    ...
    protected $casts = [
        ...
        'negotiation_max_percent' => 'float', 'surge_enabled' => 'boolean',
        'surge_multiplier' => 'float', 'status' => 'boolean',
    ];
