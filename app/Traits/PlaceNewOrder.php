...
trait PlaceNewOrder
{
    ...
    public function new_place_order(Request $request, $is_prescription = false)
    {
        $validator = Validator::make($request->all(), [
            ...
            'parcel_value' => 'required_if:order_type,parcel|numeric|min:0',
            'parcel_cod' => 'required_if:order_type,parcel|boolean',
        ...
        try {
            ...
            $order->parcel_value = $request->order_type === 'parcel' ? ($request->parcel_value ?? 0) : 0;
            $order->parcel_cod = $request->order_type === 'parcel' ? (bool)($request->parcel_cod ?? 0) : 0;
