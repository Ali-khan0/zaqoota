    ...
    private function set_data()
    {
        try {
            ...
            foreach ($data as $key => $value) {
                ...
                } elseif ($gateway == 'assan_pay') {
                    $additional_data = [
                        'status' => $decoded_value['status'],
                        'callback_url' => $decoded_value['callback_url'] ?? null,
                        'merchant_id' => $decoded_value['merchant_id'] ?? '',
                        'api_key' => $decoded_value['api_key'] ?? '',
                        'decryption_key' => $decoded_value['decryption_key'] ?? $decoded_value['secret_key'] ?? '',
                        'checkout_url' => $decoded_value['checkout_url'] ?? 'https://api.assanpay.com',
                    ];
