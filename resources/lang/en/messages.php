<?php return array (
  ...
  'Your' => 'Welcome to',
  'All Service' => 'ZAQOOTA',
  'in one field' => 'Fast Delivery, Smart Choice',
  'admin' => 'Admin',
  'signin' => 'Signin',
  ...
  'dm_registration_fee' => 'DM registration fee',
  'dm_registration_fee_settings' => 'DM registration fee settings',
  'dm_registration_fee_settings_intro' => 'Initial deposits are recorded when you approve a rider. Use these defaults for new fee records and wallet deductions.',
  'dm_registration_fee_total' => 'Total registration fee',
  'dm_registration_fee_total_hint' => 'Full amount the rider must cover (wallet deductions + manual payments).',
  'dm_registration_fee_initial_deposit' => 'Initial deposit (offline)',
  'dm_registration_fee_initial_deposit_hint' => 'Expected first payment outside the app; admin confirms when received.',
  'dm_reg_require_initial_on_approve' => 'Initial deposit on approval',
  'dm_reg_require_initial_on_approve_hint' => 'If required, approving a rider is only allowed after checking “initial deposit received”.',
  'dm_reg_fee_wallet_deduction_label' => 'Delivery bag — registration fee (wallet deduction)',
  'dm_reg_fee_manual_initial_label' => 'Initial registration deposit (paid outside wallet)',
  'dm_reg_fee_wallet_deduction_hint' => 'Amounts deducted from your wallet go toward your registration fee for the delivery bag until your balance is cleared.',
  'dm_list_initial_deposit' => 'Initial deposit',
  'dm_list_reg_fee_remaining' => 'Reg. fee remaining',
  'dm_approve_modal_title' => 'Approve delivery man',
  'dm_approve_initial_deposit_received' => 'Initial deposit received',
  'dm_approve_initial_amount' => 'Amount received',
  'dm_approve_confirm_required' => 'You must confirm initial deposit received before approving.',
  'dm_edit_registration_fee_section' => 'Registration fee & initial deposit',
  'dm_edit_initial_not_recorded' => 'Not recorded yet — confirm at rider approval.',
  'dm_edit_initial_expected_hint' => 'Default expected initial deposit (global setting):',
  'dm_reg_fee_disabled_edit_hint' => 'Registration fee module is turned off in business settings. Historical records may still appear below.',
  'recorded' => 'Recorded',
  'dm_milestone_bonus' => 'DM milestone bonus',
  'dm_bonus_awards' => 'DM bonus awards',
  'confirm_manual_fee' => 'Confirm manual fee',
  ...
  'milestone_slot' => 'Milestone slot',
  'total_bonus_earned' => 'Total bonus earned',
  'registration_fee_ledger' => 'Registration fee & ledger',
  'frequency' => 'Frequency',
...
Smartly or Earn. ',
  ...
  'Foods' => 'Foods',
  'services_policy' => 'Services policy',
  'Account Deletion Request' => 'Account Deletion Request',
  'All Products with Stores' => 'All Products with Stores',
  'Please enter your email address to submit a request for account deletion. Our admin team will review your request.' => 'Please enter your email address to submit a request for account deletion. Our admin team will review your request.',
  'Your Email Address' => 'Your Email Address',
  'Reason for account deletion (Optional)' => 'Reason for account deletion (Optional)',
  ...
  'customer_withdraws' => 'Customer withdraws',
  'Card' => 'Card',
  ...
  'Please add more options or change the max value forServing' => 'Please add more options or change the max value forServing',
  'Too many login attempts. Try again in 21 seconds.' => 'Too many login attempts. Try again in 21 seconds.',
  'First_Name' => 'First Name',
  'Last_Name' => 'Last Name',
  ...
  'Minahil paid online to Askari Bank' => 'Minahil paid online to Askari Bank',
  'Please add more options or change the max value forChicken Tikka' => 'Please add more options or change the max value forChicken Tikka',
  'Default_question_is_required' => 'Default question is required',
  'User_type_required' => 'User type required',
  'customer_withdraw_transaction' => 'Customer withdraw transaction',
  ...
  'partial_payment_is_not_active' => 'Partial payment is not active',
  ...
  'Customer Withdraw Request' => 'Customer Withdraw Request',
  'wallet_Balance' => 'Wallet Balance',
  ...
  'EX: 10' => 'EX: 10',
  'The email field is required when verification method is email.' => 'The email field is required when verification method is email.',
  'cash adjustment from test orders' => 'Cash adjustment from test orders',
  ...
  'parcel_cod' => 'Parcel cod',
  'you referred completed thier first order' => 'You referred completed thier first order',
  'Already_Adjusted' => 'Already Adjusted',
  'iban' => 'Iban',
  'The price field is required.' => 'The price field is required.',
  'Category required' => 'Category required',
  'Please add more options or change the max value forPlan Fries' => 'Please add more options or change the max value forPlan Fries',
  'referrer' => 'Referrer',
  'Referrer' => 'Referrer',
  'Minimum value can not be greater then maximum value' => 'Minimum value can not be greater then maximum value',
  'Please add more options or change the max value forExtra Volcano Sauce' => 'Please add more options or change the max value forExtra Volcano Sauce',
  ...
  'Onboarding Invoices' => 'Onboarding Invoices',
  'Create Onboarding Invoice' => 'Create Onboarding Invoice',
  'Create Invoice' => 'Create Invoice',
  'Create and Send to Store' => 'Create and Send to Store',
  'Invoice List' => 'Invoice List',
  'Store Details' => 'Store Details',
  'Business Module' => 'Business Module',
  'Select module' => 'Select module',
  'Store' => 'Store',
  'Search store by name' => 'Search store by name',
  'Previously selected store' => 'Previously selected store',
  'Start typing to find an active store in the selected module.' => 'Start typing to find an active store in the selected module.',
  'Start typing to find a store in the selected module.' => 'Start typing to find a store in the selected module.',
  'Financial Details' => 'Financial Details',
  'Invoice Number' => 'Invoice Number',
  'Generated automatically when the invoice is created.' => 'Generated automatically when the invoice is created.',
  ...
  'Due Date' => 'Due Date',
  'Additional Recipient Emails' => 'Additional Recipient Emails',
  'Optional' => 'Optional',
  'The invoice will also be sent to these addresses. Separate multiple emails with commas.' => 'The invoice will also be sent to these addresses. Separate multiple emails with commas.',
  ...
  'invoices' => 'invoices',
  'Search invoice number, store or email' => 'Search invoice number, store or email',
  'All payment statuses' => 'All payment statuses',
  'All send statuses' => 'All send statuses',
  'Paid' => 'Paid',
  'Unpaid' => 'Unpaid',
  'Sent' => 'Sent',
  'Not sent' => 'Not sent',
  ...
  'Update' => 'Update',
  'Changing an unpaid invoice to paid automatically emails the paid invoice to the store.' => 'Changing an unpaid invoice to paid automatically emails the paid invoice to the store.',
  'Email Delivery' => 'Email Delivery',
  'Status' => 'Status',
  'Recipients' => 'Recipients',
  'No valid recipient' => 'No valid recipient',
  'Last sent' => 'Last sent',
  'Last error' => 'Last error',
  'The selected store does not belong to this module.' => 'The selected store does not belong to this module.',
  'Enter valid additional email addresses separated by commas.' => 'Enter valid additional email addresses separated by commas.',
  'Add at least one valid recipient email before sending the invoice.' => 'Add at least one valid recipient email before sending the invoice.',
  'Invoice created, but the email could not be sent. You can retry from the invoice page.' => 'Invoice created, but the email could not be sent. You can retry from the invoice page.',
  'Invoice created successfully.' => 'Invoice created successfully.',
  'Invoice sent successfully.' => 'Invoice sent successfully.',
  'Invoice could not be sent. Check the recorded error and mail configuration.' => 'Invoice could not be sent. Check the recorded error and mail configuration.',
  'Invoice payment status updated.' => 'Invoice payment status updated.',
  'The store does not have a valid email address.' => 'The store does not have a valid email address.',
  'Owner' => 'Owner',
  ...
  'Private Admin Note' => 'Private Admin Note',
  'Shown on the invoice PDF' => 'Shown on the invoice PDF',
  'Only admins can see this note' => 'Only admins can see this note',
  'Invoice total must be greater than zero.' => 'Invoice total must be greater than zero.',
  'Due Soon' => 'Due Soon',
  'Overdue' => 'Overdue',
  'Void' => 'Void',
  ...
  'Required when paid' => 'Required when paid',
  'Optional transaction reference' => 'Optional transaction reference',
  'Update Payment' => 'Update Payment',
  'Recipients and Delivery' => 'Recipients and Delivery',
  'Primary' => 'Primary',
  'Add Recipient' => 'Add Recipient',
  'Send to' => 'Send to',
  'Send Payment Reminder' => 'Send Payment Reminder',
  'Void Invoice' => 'Void Invoice',
  'Reason for voiding this invoice' => 'Reason for voiding this invoice',
  'Delivery History' => 'Delivery History',
  'Recipient' => 'Recipient',
  'Type' => 'Type',
  'Date' => 'Date',
  'No delivery attempts yet' => 'No delivery attempts yet',
  'Audit Timeline' => 'Audit Timeline',
  'System' => 'System',
  'No activity recorded' => 'No activity recorded',
  'Please wait before sending another reminder.' => 'Please wait before sending another reminder.',
  'Payment reminder processed.' => 'Payment reminder processed.',
  'Recipient added successfully.' => 'Recipient added successfully.',
  'Recipient removed successfully.' => 'Recipient removed successfully.',
  'Invoice voided successfully.' => 'Invoice voided successfully.',
  'Invoice Payment Details' => 'Invoice Payment Details',
  ...
  'Please use the invoice number as your payment reference.' => 'Please use the invoice number as your payment reference.',
  'Invoice payment details updated successfully.' => 'Invoice payment details updated successfully.',
  'ride_hailing' => 'Ride Hailing',
  'Ride Hailing' => 'Ride Hailing',
  'Ride Hailing Setup' => 'Ride Hailing Setup',
  'Basic Setup' => 'Basic Setup',
  ...
  'Ride hailing setup updated successfully.' => 'Ride hailing setup updated successfully.',
  'Ride Hailing Dashboard' => 'Ride Hailing Dashboard',
  'Ride Operations' => 'Ride Operations',
  'Last Captain Location' => 'Last Captain Location',
  'Updated' => 'Updated',
  'View on Map' => 'View on Map',
  'Trip Times' => 'Trip Times',
  'Requested' => 'Requested',
  'Ride Started' => 'Ride Started',
  'Wallet Paid' => 'Wallet Paid',
  'Remaining Due' => 'Remaining Due',
  'Ride Coupons' => 'Ride Coupons',
  'Create admin-sponsored discounts for eligible passenger Rides.' => 'Create admin-sponsored discounts for eligible passenger Rides.',
  'Create Ride Coupon' => 'Create Ride Coupon',
  'Edit Ride Coupon' => 'Edit Ride Coupon',
  'Cancel Edit' => 'Cancel Edit',
  'Title' => 'Title',
  'Example: First Ride Offer' => 'Example: First Ride Offer',
  'Discount Type' => 'Discount Type',
  'Fixed Amount' => 'Fixed Amount',
  'Percentage' => 'Percentage',
  'Maximum Discount' => 'Maximum Discount',
  'Minimum Accepted Fare' => 'Minimum Accepted Fare',
  'Total Usage Limit' => 'Total Usage Limit',
  'Limit Per Passenger' => 'Limit Per Passenger',
  'Pickup Zones' => 'Pickup Zones',
  'Leave empty for all available zones.' => 'Leave empty for all available zones.',
  'Leave empty for all Ride categories.' => 'Leave empty for all Ride categories.',
  'Payment Methods' => 'Payment Methods',
  ...
  'First Ride Only' => 'First Ride Only',
  'Update Coupon' => 'Update Coupon',
  'Create Coupon' => 'Create Coupon',
  'Ride Coupon List' => 'Ride Coupon List',
  'Search title or code' => 'Search title or code',
  'Coupon' => 'Coupon',
  'Scope' => 'Scope',
  'Usage' => 'Usage',
  'Minimum' => 'Minimum',
  ...
  'Reserved' => 'Reserved',
  'Unlimited' => 'Unlimited',
  'Delete this unused Ride coupon?' => 'Delete this unused Ride coupon?',
  'No Ride coupons found.' => 'No Ride coupons found.',
  'Ride Coupon Usage' => 'Ride Coupon Usage',
  'Passenger' => 'Passenger',
  'Reserved At' => 'Reserved At',
  'Completed At' => 'Completed At',
  'No coupon usage found.' => 'No coupon usage found.',
  'Ride coupon created successfully.' => 'Ride coupon created successfully.',
  'Ride coupon updated successfully.' => 'Ride coupon updated successfully.',
  'Ride coupon status updated.' => 'Ride coupon status updated.',
  'Ride coupon deleted successfully.' => 'Ride coupon deleted successfully.',
  'A used Ride coupon cannot be deleted. Disable it instead.' => 'A used Ride coupon cannot be deleted. Disable it instead.',
  'Coupon Discount' => 'Coupon Discount',
  'Manage ride vehicles, categories and zone pricing.' => 'Manage ride vehicles, categories and zone pricing.',
  'Register Vehicle' => 'Register Vehicle',
  'Riders in Ride Mode' => 'Riders in Ride Mode',
  'Registered Vehicles' => 'Registered Vehicles',
  'Approved Vehicles' => 'Approved Vehicles',
  'Pending Approval' => 'Pending Approval',
  'Active Categories' => 'Active Categories',
  'Configured Zone Fares' => 'Configured Zone Fares',
  'Foundation Status' => 'Foundation Status',
  'Rider Work Mode' => 'Rider Work Mode',
  'Riders receive either deliveries or ride requests, never both.' => 'Riders receive either deliveries or ride requests, never both.',
  'Vehicle Limit' => 'Vehicle Limit',
  'Each rider can register up to two ride vehicles.' => 'Each rider can register up to two ride vehicles.',
  'Fare Scope' => 'Fare Scope',
  'Every fare is configured by zone and ride category.' => 'Every fare is configured by zone and ride category.',
  'Ride Management' => 'Ride Management',
  'Ride Vehicles' => 'Ride Vehicles',
  'Ride Categories' => 'Ride Categories',
  'Zone Ride Pricing' => 'Zone Ride Pricing',
  'Configuration' => 'Configuration',
  'Add Ride Category' => 'Add Ride Category',
  ...
  'Vehicles' => 'Vehicles',
  'Any' => 'Any',
  'This ride category already exists.' => 'This ride category already exists.',
  'Ride category created successfully.' => 'Ride category created successfully.',
  'Ride category status updated.' => 'Ride category status updated.',
  'Register Ride Vehicle' => 'Register Ride Vehicle',
  'Rider and Vehicle Details' => 'Rider and Vehicle Details',
  'Rider' => 'Rider',
  'Only approved riders with fewer than two ride vehicles appear.' => 'Only approved riders with fewer than two ride vehicles appear.',
  'Ride Category' => 'Ride Category',
  'Select vehicle type first' => 'Select vehicle type first',
  'Make' => 'Make',
  'Model' => 'Model',
  ...
  'Admin Note' => 'Admin Note',
  'Search rider name or phone' => 'Search rider name or phone',
  'Search rider, phone, plate, make or model' => 'Search rider, phone, plate, make or model',
  'Registration' => 'Registration',
  'Active Vehicle' => 'Active Vehicle',
  'Make Active' => 'Make Active',
  'No ride vehicles found.' => 'No ride vehicles found.',
  'The category does not belong to the selected vehicle type.' => 'The category does not belong to the selected vehicle type.',
  'The fuel type does not match the selected ride category.' => 'The fuel type does not match the selected ride category.',
  'A rider can register a maximum of two ride vehicles.' => 'A rider can register a maximum of two ride vehicles.',
  'Ride vehicle registered successfully.' => 'Ride vehicle registered successfully.',
  'Ride vehicle status updated.' => 'Ride vehicle status updated.',
  'Only an approved ride vehicle can be activated.' => 'Only an approved ride vehicle can be activated.',
  'Active ride vehicle updated.' => 'Active ride vehicle updated.',
  'Fares are saved independently for every zone and ride category.' => 'Fares are saved independently for every zone and ride category.',
  'Create an active zone before configuring ride fares.' => 'Create an active zone before configuring ride fares.',
  ...
  'Pickup Distance Charge' => 'Pickup Distance Charge',
  'Waiting Per Minute' => 'Waiting Per Minute',
  'Cancellation Charge' => 'Cancellation Charge',
  'Platform Commission' => 'Platform Commission',
  'Minimum Negotiated Fare' => 'Minimum Negotiated Fare',
  'Maximum Negotiated Fare' => 'Maximum Negotiated Fare',
  'Percentage of calculated fare' => 'Percentage of calculated fare',
  'Surge Multiplier' => 'Surge Multiplier',
  'Enable Surge' => 'Enable Surge',
  'Save Zone Fares' => 'Save Zone Fares',
  'Minimum negotiation percentage cannot exceed maximum percentage.' => 'Minimum negotiation percentage cannot exceed maximum percentage.',
  'One of the selected ride categories is invalid.' => 'One of the selected ride categories is invalid.',
  'Zone ride fares updated successfully.' => 'Zone ride fares updated successfully.',
  'Complete your active deliveries before switching to Ride mode.' => 'Complete your active deliveries before switching to Ride mode.',
  'An approved active ride vehicle is required for Ride mode.' => 'An approved active ride vehicle is required for Ride mode.',
  'Rider work mode updated successfully.' => 'Rider work mode updated successfully.',
  'Switch to Delivery mode before accepting a delivery order.' => 'Switch to Delivery mode before accepting a delivery order.',
  'Ride vehicle not found.' => 'Ride vehicle not found.',
  'Add Ride Vehicle' => 'Add Ride Vehicle',
  'Ride Riders' => 'Ride Riders',
  'Existing Rider Account' => 'Existing Rider Account',
  'Select an existing approved rider. This does not create a new rider account.' => 'Select an existing approved rider. This does not create a new rider account.',
  'Only riders with fewer than two ride vehicles appear.' => 'Only riders with fewer than two ride vehicles appear.',
  'These are existing rider accounts shared with the delivery system.' => 'These are existing rider accounts shared with the delivery system.',
  'Search rider name, phone or email' => 'Search rider name, phone or email',
  'All Work Modes' => 'All Work Modes',
  'Delivery Mode' => 'Delivery Mode',
  'Ride Mode' => 'Ride Mode',
  'Work Mode' => 'Work Mode',
  'Active Ride Vehicle' => 'Active Ride Vehicle',
  'Account Status' => 'Account Status',
  'No active ride vehicle' => 'No active ride vehicle',
  'Online' => 'Online',
  'Offline' => 'Offline',
  ...
  'Switch to Ride Mode' => 'Switch to Ride Mode',
  'Switch to Delivery Mode' => 'Switch to Delivery Mode',
  'Only approved riders can change work mode.' => 'Only approved riders can change work mode.',
  'Rider is currently assigned to non-parcel order(s)' => 'Rider is currently assigned to non-parcel order(s)',
  'Complete the order before switching work mode.' => 'Complete the order before switching work mode.',
  'CNIC' => 'CNIC',
  'Identity Document Photos' => 'Identity Document Photos',
  'Vehicle Front Photo' => 'Vehicle Front Photo',
  'Vehicle Back Photo' => 'Vehicle Back Photo',
  'Front' => 'Front',
  'Back' => 'Back',
  'Not provided' => 'Not provided',
  'Face Photo' => 'Face Photo',
  'Become Captain' => 'Become Captain',
  'Become Partner' => 'Become Partner',
  'Move with purpose. Earn with Zaqoota.' => 'Move with purpose. Earn with Zaqoota.',
  'Register once to deliver orders, carry parcels, and submit your vehicle for ride approval.' => 'Register once to deliver orders, carry parcels, and submit your vehicle for ride approval.',
  'Complete your details and submit your vehicle for verification.' => 'Complete your details and submit your vehicle for verification.',
  'Personal Information' => 'Personal Information',
  'Vehicle Information' => 'Vehicle Information',
  'Verification Photos' => 'Verification Photos',
  'Identity Document Front' => 'Identity Document Front',
  'Identity Document Back' => 'Identity Document Back',
  ...
  'Share your business details to start your partnership with Zaqoota.' => 'Share your business details to start your partnership with Zaqoota.',
  'Partner Details' => 'Partner Details',
  'Submit Partner Application' => 'Submit Partner Application',
  'Application Submitted' => 'Application Submitted',
  'Your partner application has been submitted successfully.' => 'Your partner application has been submitted successfully.',
  'Your partner application has been submitted successfully. Our team will review it and contact you soon.' => 'Your partner application has been submitted successfully. Our team will review it and contact you soon.',
  'Back to Home' => 'Back to Home',
  'Zaqoota Information' => 'Zaqoota Information',
  'Information pages' => 'Information pages',
  'Information' => 'Information',
  'Learn more about Zaqoota and the people we serve.' => 'Learn more about Zaqoota and the people we serve.',
  'How Zaqoota collects, uses and protects your information.' => 'How Zaqoota collects, uses and protects your information.',
  'The standards and policies that guide Zaqoota services.' => 'The standards and policies that guide Zaqoota services.',
  'Please review the terms that apply when using Zaqoota.' => 'Please review the terms that apply when using Zaqoota.',
  'Zaqoota Support' => 'Zaqoota Support',
  'We are here to help with your questions and feedback.' => 'We are here to help with your questions and feedback.',
  'Contact information' => 'Contact information',
  'Reach the Zaqoota team using the details below.' => 'Reach the Zaqoota team using the details below.',
  'Business hours' => 'Business hours',
  'Send us a message' => 'Send us a message',
  'Complete the form and our team will get back to you.' => 'Complete the form and our team will get back to you.',
  'Message' => 'Message',
  ...
  'Seconds' => 'Seconds',
  'Ride Operations' => 'Ride Operations',
  'Monitor current rides, Captain assignment, trip progress and payment status.' => 'Monitor current rides, Captain assignment, trip progress and payment status.',
  'Auto refresh every 15 seconds' => 'Auto refresh every 15 seconds',
  'Auto Refresh' => 'Auto Refresh',
  'All Rides' => 'All Rides',
  'Need Captain' => 'Need Captain',
  'Active Rides' => 'Active Rides',
  'Completed Rides' => 'Completed Rides',
  'Ride number, customer, Captain or location' => 'Ride number, customer, Captain or location',
  'All Categories' => 'All Categories',
  'Ride Status' => 'Ride Status',
  'Searching Captain' => 'Searching Captain',
  'Offers Received' => 'Offers Received',
  'Captain Assigned' => 'Captain Assigned',
  'Captain Coming' => 'Captain Coming',
  'Captain Arrived' => 'Captain Arrived',
  'Ride In Progress' => 'Ride In Progress',
  'Not Assigned' => 'Not Assigned',
  'The Captain is coming to pickup.' => 'The Captain is coming to pickup.',
  'View Ride' => 'View Ride',
  ...
  'Offers and Payments' => 'Offers and Payments',
  'Person / Method' => 'Person / Method',
  'Captain Offer' => 'Captain Offer',
  'No offers or payments yet.' => 'No offers or payments yet.',
  'Assign Captain' => 'Assign Captain',
  'Eligible Captain' => 'Eligible Captain',
  'Select Captain' => 'Select Captain',
  'Final Fare' => 'Final Fare',
  'Allowed range' => 'Allowed range',
  'No eligible Captain is currently available in this zone and category.' => 'No eligible Captain is currently available in this zone and category.',
  'Customer and Captain' => 'Customer and Captain',
  'Fare and Payment' => 'Fare and Payment',
  'Customer Offer' => 'Customer Offer',
  'Accepted Fare' => 'Accepted Fare',
  'Waiting Charge' => 'Waiting Charge',
  'Cancellation Charge' => 'Cancellation Charge',
  'Final Payable' => 'Final Payable',
  'Zaqoota Commission' => 'Zaqoota Commission',
  'Captain Earning' => 'Captain Earning',
  'Receipt' => 'Receipt',
  'This ride already has a Captain or is no longer assignable.' => 'This ride already has a Captain or is no longer assignable.',
  'The selected Captain is no longer eligible for this ride.' => 'The selected Captain is no longer eligible for this ride.',
  'The fare must remain inside the configured negotiation range.' => 'The fare must remain inside the configured negotiation range.',
  'Captain assigned successfully.' => 'Captain assigned successfully.',
  'Ride Service Rules' => 'Ride Service Rules',
  'Ride Banners' => 'Ride Banners',
  'Show targeted promotions inside the passenger Ride experience.' => 'Show targeted promotions inside the passenger Ride experience.',
  'Edit Ride Banner' => 'Edit Ride Banner',
  'Create Ride Banner' => 'Create Ride Banner',
  'Ride Category' => 'Ride Category',
  'Starts At' => 'Starts At',
  'Expires At' => 'Expires At',
  'Sort Order' => 'Sort Order',
  'No Action' => 'No Action',
  'Open Ride Home' => 'Open Ride Home',
  'Apply Ride Coupon' => 'Apply Ride Coupon',
  'Open URL' => 'Open URL',
  'Action Value' => 'Action Value',
  'Enter a Ride coupon code or a complete HTTPS URL.' => 'Enter a Ride coupon code or a complete HTTPS URL.',
  'Banner Image' => 'Banner Image',
  'View Current Image' => 'View Current Image',
  'Update Banner' => 'Update Banner',
  'Create Banner' => 'Create Banner',
  'Ride Banner List' => 'Ride Banner List',
  'Search banners' => 'Search banners',
  'Delete this Ride banner?' => 'Delete this Ride banner?',
  'No Ride banners found.' => 'No Ride banners found.',
  'Ride banner created successfully.' => 'Ride banner created successfully.',
  'Ride banner updated successfully.' => 'Ride banner updated successfully.',
  'Ride banner status updated.' => 'Ride banner status updated.',
  'Ride banner deleted successfully.' => 'Ride banner deleted successfully.',
  'Ride Push Notifications' => 'Ride Push Notifications',
  'Send Ride promotions to all passengers or a selected zone.' => 'Send Ride promotions to all passengers or a selected zone.',
  'Create and Send Notification' => 'Create and Send Notification',
  ...
  'No Ride notifications found.' => 'No Ride notifications found.',
  'Ride notification created and sent.' => 'Ride notification created and sent.',
  'Ride notification sent again.' => 'Ride notification sent again.',
  'Ride notification feed status updated.' => 'Ride notification feed status updated.',
  'Ride notification deleted successfully.' => 'Ride notification deleted successfully.',
  'Maximum Pickup Radius' => 'Maximum Pickup Radius',
  'Only Captains inside this pickup radius can see and offer on a Ride.' => 'Only Captains inside this pickup radius can see and offer on a Ride.',
  'Pickup ETA Average Speed' => 'Pickup ETA Average Speed',
  'Used to estimate pickup time; it does not change the passenger fare.' => 'Used to estimate pickup time; it does not change the passenger fare.',
  'Cancel Ride' => 'Cancel Ride',
  'Cancellation Reason' => 'Cancellation Reason',
  'Cancel this Ride and notify the passenger and Captain?' => 'Cancel this Ride and notify the passenger and Captain?',
  'Ride Cancelled by' => 'Ride Cancelled by',
  'Cancelled by' => 'Cancelled by',
  'Passenger' => 'Passenger',
  'Zaqoota Admin' => 'Zaqoota Admin',
  'No cancellation reason was provided.' => 'No cancellation reason was provided.',
  'An in-progress or completed Ride cannot be cancelled.' => 'An in-progress or completed Ride cannot be cancelled.',
  'Ride cancelled and both parties were notified.' => 'Ride cancelled and both parties were notified.',
  'Notification Messages' => 'Notification Messages',
  'Ride Notification Messages' => 'Ride Notification Messages',
  'Configure condition-based messages separately for passengers and Captains.' => 'Configure condition-based messages separately for passengers and Captains.',
  'Available Variables' => 'Available Variables',
  'Push' => 'Push',
  'In-App' => 'In-App',
  'Save Notification Messages' => 'Save Notification Messages',
  'Ride notification messages updated successfully.' => 'Ride notification messages updated successfully.',
  'Passenger Accepted Offer' => 'Passenger Accepted Offer',
  'Admin Assigned Captain - Passenger' => 'Admin Assigned Captain - Passenger',
  'Admin Assigned Ride - Captain' => 'Admin Assigned Ride - Captain',
  'Passenger Cancelled - No Charge' => 'Passenger Cancelled - No Charge',
  'Passenger Cancelled - Compensation Due' => 'Passenger Cancelled - Compensation Due',
  'Captain Cancelled' => 'Captain Cancelled',
  'Admin Cancelled - Passenger' => 'Admin Cancelled - Passenger',
  'Admin Cancelled - Captain' => 'Admin Cancelled - Captain',
