...
@section('title', translate('messages.Become Partner'))
@push('css_or_js')
    ...
    @push('script_2')
        ...
        <script src="{{ asset('public/assets/admin/js/view-pages/vendor-registration.js') }}"></script>
            @if(isset($recaptcha) && $recaptcha['status'] == 1)
                ...
                <script src="https://www.google.com/recaptcha/api.js?render={{ \App\CentralLogics\Helpers::get_business_settings('recaptcha')['site_key'] }}"></script>
                <script>
                    "use strict";
                    $("#form-id").on('submit',function(e) {
                        ...
                        grecaptcha.ready(function () {
                            grecaptcha.execute('{{ \App\CentralLogics\Helpers::get_business_settings('recaptcha')['site_key'] }}', { action: 'submit' })
                                .then(function (token) {
