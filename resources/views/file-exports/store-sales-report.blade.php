        ...
        <thead>
            ...
            <tr>
                ...
                <th>
                    ...
                    <br>
                    {{ translate('total_commission')  }}- {{ \App\CentralLogics\Helpers::number_format_short($data['orders']->sum('transaction_sum_admin_commission')-$data['orders']->sum('transaction_sum_fleet_manager_commission')) }}
                    <br>
