            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('withdraw_list'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/customer/withdraw*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.customer.withdraw_list') }}" title="{{ translate('messages.customer_withdraws') }}">
                                <i class="tio-table nav-icon"></i>
