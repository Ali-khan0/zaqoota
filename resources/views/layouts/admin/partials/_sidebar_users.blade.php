    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ request()->routeIs('admin.users.delivery-man.milestone-bonus') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.delivery-man.milestone-bonus') }}" title="{{ translate('messages.dm_milestone_bonus') }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ request()->routeIs('admin.users.delivery-man.milestone-bonus.awards') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.delivery-man.milestone-bonus.awards') }}" title="{{ translate('messages.dm_bonus_awards') }}">
                        <i class="tio-medal nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.dm_bonus_awards') }}
                        </span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man/registration-fee*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.delivery-man.registration-fee') }}" title="{{ translate('messages.dm_registration_fee_settings') }}">
                        <i class="tio-money nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.dm_registration_fee_settings') }}
                        </span>
                    </a>
                </li>
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/delivery-man/fleet-manager/payment/collections') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.delivery-man.fleet-manager.collections') }}" title="{{ __('fleet_management.payment_recoveries') }}">
                        <i class="tio-money nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('fleet_management.payment_recoveries') }}</span>
                    </a>
                </li>
                @endif
                <!-- End DeliveryMan -->
