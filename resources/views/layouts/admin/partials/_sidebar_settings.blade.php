                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('admin/business-settings/pages/business-page/services-policy') ? 'active' : '' }}">
                                            <a class="nav-link "
                                                href="{{ route('admin.business-settings.services-policy') }}"
                                                title="{{ translate('messages.services_policy') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ translate('messages.services_policy') }}</span>
                                            </a>
                                        </li>
