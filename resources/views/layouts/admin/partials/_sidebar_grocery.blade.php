<div id="sidebarMain" class="d-none">
    ...
    \App\CentralLogics\Helpers::module_permission_check('item'))
                    ...
                    <li class="nav-item">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/item/all-products-stores') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.item.all-products-stores') }}" title="{{ translate('All Products with Stores') }}">
                                <span class="tio-apps nav-icon"></span>
                                <span class="text-truncate">{{ translate('All Products with Stores') }}</span>
                            </a>
                        </li>
                    @endif
                    <!-- End Store -->
