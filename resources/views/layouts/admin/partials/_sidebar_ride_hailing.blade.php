        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-hailing/rides*') ? 'active' : '' }}"><a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.ride-hailing.rides.index') }}" title="{{ translate('messages.Ride Operations') }}"><i class="tio-taxi nav-icon"></i><span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.Ride Operations') }}</span></a></li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-hailing/cancellation-reasons*') ? 'active' : '' }}"><a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.ride-hailing.cancellation-reasons.index') }}" title="{{ translate('messages.Ride Cancellation Reasons') }}"><i class="tio-clear-circle nav-icon"></i><span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.Ride Cancellation Reasons') }}</span></a></li>
                    <li class="navbar-vertical-aside-has-menu"><a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.business-settings.zone.home') }}" title="{{ translate('messages.Zone Fare Setup') }}"><i class="tio-money nav-icon"></i><span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.Zone Fare Setup') }}</span></a></li>
                    <li class="nav-item"><small class="nav-subtitle">{{ translate('messages.Promotion Management') }}</small><small class="tio-more-horizontal nav-subtitle-replacer"></small></li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-hailing/coupons*') ? 'active' : '' }}"><a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.ride-hailing.coupons.index') }}" title="{{ translate('messages.Ride Coupons') }}"><i class="tio-gift nav-icon"></i><span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.Ride Coupons') }}</span></a></li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-hailing/banners*') ? 'active' : '' }}"><a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.ride-hailing.banners.index') }}" title="{{ translate('messages.Ride Banners') }}"><i class="tio-image nav-icon"></i><span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.Ride Banners') }}</span></a></li>
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/ride-hailing/push-notifications*') ? 'active' : '' }}"><a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.ride-hailing.push-notifications.index') }}" title="{{ translate('messages.Push Notifications') }}"><i class="tio-notifications-on nav-icon"></i><span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.Push Notifications') }}</span></a></li>
