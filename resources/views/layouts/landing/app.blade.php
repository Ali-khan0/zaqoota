            ...
            <div class="container">
                <div class="navbar-bottom-wrapper">
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a href="{{route('services-policy')}}" class="{{ Request::is('services-policy') ? 'active' : '' }}"><span>{{ translate('messages.services_policy') }}</span></a>
                        </li>
                        <li>
                        ...
                        @if ($fixed_link &&$fixed_link['web_app_url_status'])
                            <div class="me-2 d-lg-none">
                                <a class="cmn--btn me-xl-auto py-2" href="{{ $fixed_link['web_app_url'] }}" target="_blank">Open Zaqoota</a>
                            </div>
                        @endif
                    </ul>
                ...
                <div class="footer-wrapper ps-xl-5">
                    ...
                    <div class="footer-widget widget-links">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{route('services-policy')}}">{{ translate('messages.services_policy') }}</a>
                            </li>
                            <li>
