                        ...
                        <tbody id="set-rows">
                            @foreach ($order_transactions as $k => $ot)
                                <tr scope="row">
                                    ...
                                    {{-- admin_commission --}}
                                    <td class="white-space-nowrap">{{ \App\CentralLogics\Helpers::format_currency($ot->net_non_delivery_commission - $ot->additional_charge - $ot->order['flash_admin_discount_amount']) }}</td>
                                    ...
                                    <td class="white-space-nowrap">{{ \App\CentralLogics\Helpers::format_currency($ot->net_delivery_commission) }}</td>
                                    {{-- admin_net_income --}}
                                    <td class="white-space-nowrap">{{ \App\CentralLogics\Helpers::format_currency($ot->net_admin_commission - $ot->order['flash_admin_discount_amount']) }}</td>
