            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        ...
                        <th class="border-0 text-capitalize">{{ translate('messages.dm_list_initial_deposit') }}</th>
                        <th class="border-0 text-capitalize">{{ translate('messages.dm_list_reg_fee_remaining') }}</th>
