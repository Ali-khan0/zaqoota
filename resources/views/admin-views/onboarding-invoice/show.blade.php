        ...
        <div class="col-lg-8">
            <div class="card overflow-hidden" style="border:1px solid rgba(13,152,141,.2);">
                ...
                <div class="card-body p-4 p-md-5">
                    <div class="row mb-5">
                        <div class="col-6"><h5>{{ translate('Bill to') }}</h5><strong>{{ $invoice->store_name }}</strong><br>@if($invoice->store_owner_name)<span class="text-muted">{{ translate('Owner') }}: {{ $invoice->store_owner_name }}</span><br>@endif{{ $invoice->store_email }}<br><span class="text-muted">{{ $invoice->store_address }}</span></div>
